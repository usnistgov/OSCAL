...
<!-- Parameter setting 'json-indent=yes' produces JSON indented using the internal serializer-->
   ...
   <xsl:strip-space elements="plan-of-action-and-milestones metadata revision annotation link role location address party responsible-party import-ssp local-definitions component status responsible-role protocol port-range inventory-item implemented-component observation origin actor related-task subject include-all include-subject exclude-subject identified-subject relevant-evidence risk characterization facet mitigating-factor response required-asset task timing on-date within-date-range at-frequency dependency associated-activity subject-placeholder source risk-log entry logged-by related-response related-observation poam-item associated-risk back-matter resource citation biblio rlink"/>
   ...
   <xsl:template match="prop/@name | annotation/@name | plan-of-action-and-milestones/risk/characterization/facet/@name"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="NCName"
            name="name"
   ...
   <xsl:template match="annotation/@value | plan-of-action-and-milestones/risk/characterization/facet/@value"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="string"
            name="value"
   ...
   <xsl:template match="actor/@type | subject/@type | plan-of-action-and-milestones/observation/subject/@type | plan-of-action-and-milestones/risk/mitigating-factor/subject/@type | plan-of-action-and-milestones/risk/response/required-asset/subject/@type | task/@type | task//task/@type"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="NCName"
            name="type"
   ...
   <xsl:template match="actor/@uuid-ref | include-subject/@uuid-ref | exclude-subject/@uuid-ref | plan-of-action-and-milestones/observation/subject/@uuid-ref | plan-of-action-and-milestones/risk/mitigating-factor/subject/@uuid-ref | plan-of-action-and-milestones/risk/response/required-asset/subject/@uuid-ref"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="uuid"
            name="uuid-ref"
   ...
   <xsl:template match="related-task/@task-uuid | plan-of-action-and-milestones/risk/response//task/dependency/@task-uuid | plan-of-action-and-milestones/risk/response//task/associated-activity/subject-placeholder/source/@task-uuid"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="uuid"
            name="task-uuid"
