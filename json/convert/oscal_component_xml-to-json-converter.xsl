...
<!-- Parameter setting 'json-indent=yes' produces JSON indented using the internal serializer-->
   ...
   <xsl:strip-space elements="component-definition metadata revision prop link role location address party responsible-party action import-component-definition rule test testing-scenario condition prerequisite test-reference testing-scenario-reference component responsible-role protocol port-range control-implementation set-parameter implemented-requirement statement rule-implementation capability incorporates-component back-matter resource citation rlink"/>
   ...
   <xsl:template match="component-definition/rule/title"
                 priority="5"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/rule/description"
                 priority="5"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="component-definition/rule/link/text"
                 priority="7"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/test/title"
                 priority="5"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/test/description"
                 priority="5"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="component-definition/test/link/text"
                 priority="7"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/testing-scenario/link/text"
                 priority="7"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/testing-scenario//condition/link/text"
                 priority="9"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/statement/rule-implementation/description"
                 priority="13"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/statement/rule-implementation/link/text"
                 priority="15"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/statement/rule-implementation//condition/link/text"
                 priority="17"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/statement/rule-implementation/rule-uuid"
                 priority="15"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/rule-implementation/description"
                 priority="11"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/rule-implementation/link/text"
                 priority="13"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/rule-implementation//condition/link/text"
                 priority="15"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/component/control-implementation/implemented-requirement/rule-implementation/rule-uuid"
                 priority="13"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/statement/rule-implementation/description"
                 priority="13"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/statement/rule-implementation/link/text"
                 priority="15"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/statement/rule-implementation//condition/link/text"
                 priority="17"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/statement/rule-implementation/rule-uuid"
                 priority="15"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/rule-implementation/description"
                 priority="11"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/rule-implementation/link/text"
                 priority="13"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/rule-implementation//condition/link/text"
                 priority="15"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="component-definition/capability/control-implementation/implemented-requirement/rule-implementation/rule-uuid"
                 priority="13"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
