...
<!-- Parameter setting 'json-indent=yes' produces JSON indented using the internal serializer-->
   ...
   <xsl:strip-space elements="mapping-collection metadata revision prop link role location address party responsible-party mapping source-resource target-resource map source target back-matter resource citation rlink"/>
