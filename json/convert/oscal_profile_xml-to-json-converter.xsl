...
<!-- Parameter setting 'json-indent=yes' produces JSON indented using the internal serializer-->
   ...
   <xsl:template match="prop/@class | group/@class | group//group/@class | param/@class | part/@class | part//part/@class | profile/modify/set-parameter/@class"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="token"
            name="class"
   ...
   <xsl:template match="param/@depends-on | profile/modify/set-parameter/@depends-on"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="token"
            name="depends-on"
   ...
   <xsl:template match="remove/@by-id | add/@by-id"
                 xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <flag in-json="string"
            as-type="token"
            name="by-id"
