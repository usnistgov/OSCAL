...
<!-- Parameter setting 'json-indent=yes' produces JSON indented using the internal serializer-->
   ...
   <xsl:template match="profile/metadata/title" priority="4">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/published" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/last-modified" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/version" priority="4">
      <xsl:param name="with-key" select="true()"/>
      <field name="version"
             gi="version"
   ...
   <xsl:template match="profile/metadata/oscal-version" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/revisions/revision" priority="5">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/revisions" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/revisions/revision/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/revisions/revision/published" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="published"
             gi="published"
             as-type="dateTime-with-timezone"
   ...
   <xsl:template match="profile/metadata/revisions/revision/last-modified" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="last-modified"
             gi="last-modified"
             as-type="dateTime-with-timezone"
   ...
   <xsl:template match="profile/metadata/revisions/revision/version" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="version"
             gi="version"
             formal-name="Document Version"
   ...
   <xsl:template match="profile/metadata/revisions/revision/oscal-version" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="oscal-version"
             gi="oscal-version"
             formal-name="OSCAL version"
   ...
   <xsl:template match="profile/metadata/revisions/revision/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/document-id" priority="5">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/document-id/@scheme" priority="6">
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="profile/metadata/link/text" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/role/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/role/short-name" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/role/description" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/role/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/location/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/location/address" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/location/address/@type" priority="7">
      <flag in-json="string"
            as-type="string"
            name="location-type"
            key="type"
   ...
   <xsl:template match="profile/metadata/location/address/addr-line" priority="8">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/location/address/city" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/location/address/state" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/location/address/postal-code" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/location/address/country" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="country"
             gi="country"
   ...
   <xsl:template match="profile/metadata/location/email-address" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/location/telephone-number" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/location/telephone-number/@type" priority="8">
      <flag in-json="string"
            as-type="string"
            name="type"
            key="type"
   ...
   <xsl:template match="profile/metadata/location/url" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="url"
             gi="url"
             as-type="uri"
   ...
   <xsl:template match="profile/metadata/location/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/party/name" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/party/short-name" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="short-name"
             gi="short-name"
   ...
   <xsl:template match="profile/metadata/party/external-id" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/party/external-id/@scheme" priority="8">
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="profile/metadata/party/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/metadata/party/email-address" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="email-address"
             gi="email-address"
             as-type="email"
   ...
   <xsl:template match="profile/metadata/party/telephone-number" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="telephone-number"
             gi="telephone-number"
             formal-name="Telephone Number">
   ...
   <xsl:template match="profile/metadata/party/telephone-number/@type" priority="8">
      <flag in-json="string"
            as-type="string"
            name="type"
            key="type"
   ...
   <xsl:template match="profile/metadata/party/address" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="address" gi="address" formal-name="Address">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">address</xsl:attribute>
   ...
   <xsl:template match="profile/metadata/party/address/@type" priority="9">
      <flag in-json="string"
            as-type="string"
            name="location-type"
            key="type"
   ...
   <xsl:template match="profile/metadata/party/address/addr-line" priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="addr-line"
             gi="addr-line"
             formal-name="Address line"
   ...
   <xsl:template match="profile/metadata/party/address/city" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="city" gi="city" formal-name="City" in-json="SCALAR">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">city</xsl:attribute>
   ...
   <xsl:template match="profile/metadata/party/address/state" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="state" gi="state" formal-name="State" in-json="SCALAR">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">state</xsl:attribute>
   ...
   <xsl:template match="profile/metadata/party/address/postal-code" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="postal-code"
             gi="postal-code"
             formal-name="Postal Code"
   ...
   <xsl:template match="profile/metadata/party/address/country" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="country"
             gi="country"
             formal-name="Country Code"
   ...
   <xsl:template match="profile/metadata/party/member-of-organization" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/metadata/responsible-party/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/merge/custom/group/title" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/merge/custom/group/param/link/text" priority="13">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/merge/custom/group/param/label" priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="label"
             gi="label"
             as-type="markup-line"
   ...
   <xsl:template match="profile/merge/custom/group/param/usage" priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="usage"
             gi="usage"
             as-type="markup-multiline"
   ...
   <xsl:template match="profile/merge/custom/group/param/constraint/test" priority="14">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/merge/custom/group/param/guideline/prose" priority="13">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
             gi="prose"
   ...
   <xsl:template match="profile/merge/custom/group/param/select/choice" priority="14">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/merge/custom/group/link/text" priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/merge/custom/group/part/title" priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/merge/custom/group/part/prose" priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
             gi="prose"
   ...
   <xsl:template match="profile/merge/custom/group/part/link/text" priority="13">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/set-parameter/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/set-parameter/label" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="label"
             gi="label"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/set-parameter/usage" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="usage"
             gi="usage"
             as-type="markup-multiline"
   ...
   <xsl:template match="profile/modify/set-parameter/constraint/test" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="test" gi="test" formal-name="Constraint Test">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">test</xsl:attribute>
   ...
   <xsl:template match="profile/modify/set-parameter/guideline/prose" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
             gi="prose"
   ...
   <xsl:template match="profile/modify/set-parameter/select/choice" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="parameter-choice"
             gi="choice"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/alter/add/title" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/alter/add/param/link/text" priority="12">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/alter/add/param/label" priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="label"
             gi="label"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/alter/add/param/usage" priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="usage"
             gi="usage"
             as-type="markup-multiline"
   ...
   <xsl:template match="profile/modify/alter/add/param/constraint/test" priority="13">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="test" gi="test" formal-name="Constraint Test">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">test</xsl:attribute>
   ...
   <xsl:template match="profile/modify/alter/add/param/guideline/prose" priority="12">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
             gi="prose"
   ...
   <xsl:template match="profile/modify/alter/add/param/select/choice" priority="13">
      <xsl:param name="with-key" select="true()"/>
      <field name="parameter-choice"
             gi="choice"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/alter/add/link/text" priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/alter/add/part/title" priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/modify/alter/add/part/prose" priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
             gi="prose"
   ...
   <xsl:template match="profile/modify/alter/add/part/link/text" priority="12">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/back-matter/resource" priority="5">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/back-matter/resource/@uuid" priority="6">
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="profile/back-matter/resource/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="profile/back-matter/resource/description" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="profile/back-matter/resource/document-id" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="document-id"
             gi="document-id"
             formal-name="Document Identifier">
   ...
   <xsl:template match="profile/back-matter/resource/document-id/@scheme" priority="8">
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="profile/back-matter/resource/citation" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/back-matter/resource/citation/text" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="profile/back-matter/resource/citation/biblio" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/back-matter/resource/rlink" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="profile/back-matter/resource/rlink/@href" priority="8">
      <flag in-json="string"
            as-type="uri-reference"
            name="href"
            key="href"
   ...
   <xsl:template match="profile/back-matter/resource/base64" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="base64"
             gi="base64"
   ...
   <xsl:template match="profile/back-matter/resource/base64/@filename" priority="7">
      <flag in-json="string"
            as-type="uri-reference"
            name="filename"
            key="filename"
