...
<!-- Parameter setting 'json-indent=yes' produces JSON indented using the internal serializer-->
   ...
   <xsl:strip-space elements="assessment-plan metadata revision annotation link role location address party responsible-party import-ssp local-definitions component status responsible-role protocol inventory-item implemented-component user authorized-privilege objectives part terms-and-conditions reviewed-controls control-selection include-control exclude-control control-objective-selection assessment-subject include-subject exclude-subject assessment-assets tools origination assessment-activity step assessment-action timing activity-instance assessment-subject-placeholder task back-matter resource citation biblio rlink"/>
   ...
   <xsl:template match="assessment-plan">
      ...
      <assembly name="assessment-plan"
         ...
         <xsl:for-each-group select="assessment-activity" group-by="true()">
            <group in-json="ARRAY" key="assessment-activities">
               <xsl:apply-templates select="current-group()">
                  <xsl:with-param name="with-key" select="false()"/>
               </xsl:apply-templates>
            </group>
   ...
   <xsl:template match="assessment-plan/@uuid | prop/@uuid | annotation/@uuid | location/@uuid | party/@uuid | component/@uuid | protocol/@uuid | inventory-item/@uuid | user/@uuid | part/@uuid | origination/@uuid | assessment-activity/@uuid | assessment-action/@uuid">
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="prop/@name | annotation/@name | protocol/@name | part/@name">
      <flag in-json="string"
            as-type="string"
            name="name"
            key="name"
   ...
   <xsl:template match="link/@href | import-ssp/@href">
      <flag in-json="string"
   ...
   <xsl:template match="role/@id | objectives/@id">
      <flag in-json="string"
            as-type="NCName"
            name="id"
            key="id"
   ...
   <xsl:template match="objectives">
      ...
      <assembly name="local-objective"
         ...
         <xsl:for-each-group select="assessment-method" group-by="true()">
            <group in-json="ARRAY" key="assessment-methods">
               <xsl:apply-templates select="current-group()">
                  <xsl:with-param name="with-key" select="false()"/>
               </xsl:apply-templates>
            </group>
   ...
   <xsl:template match="objectives/@control-id | assessment-plan/reviewed-controls/control-selection/include-control/@control-id | assessment-plan/reviewed-controls/control-selection/exclude-control/@control-id | assessment-plan/assessment-activity/step/reviewed-controls/control-selection/include-control/@control-id | assessment-plan/assessment-activity/step/reviewed-controls/control-selection/exclude-control/@control-id | assessment-plan/assessment-activity/reviewed-controls/control-selection/include-control/@control-id | assessment-plan/assessment-activity/reviewed-controls/control-selection/exclude-control/@control-id">
      <flag in-json="string"
            as-type="NCName"
            name="control-id"
            key="control-id"
   ...
   <xsl:template match="assessment-activity">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-action">
      ...
      <assembly name="action" gi="assessment-action" formal-name="Action">
         ...
         <xsl:for-each-group select="activity-instance" group-by="true()">
            <group in-json="ARRAY" key="activity-instances">
               <xsl:apply-templates select="current-group()">
                  <xsl:with-param name="with-key" select="false()"/>
               </xsl:apply-templates>
            </group>
   ...
   <xsl:template match="assessment-plan/metadata/title" priority="4">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/published" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/last-modified" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/version" priority="4">
      <xsl:param name="with-key" select="true()"/>
      <field name="version"
             gi="version"
   ...
   <xsl:template match="assessment-plan/metadata/oscal-version" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/revisions/revision" priority="5">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/revisions" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/revisions/revision/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/document-id" priority="5">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/document-id/@scheme" priority="6">
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="assessment-plan/metadata/link/text" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/role/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/role/short-name" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/role/description" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/role/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/location/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/location/address" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/location/address/@type" priority="7">
      <flag in-json="string"
            as-type="string"
            name="location-type"
            key="type"
   ...
   <xsl:template match="assessment-plan/metadata/location/address/city" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/location/address/state" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/location/address/country" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="country"
             gi="country"
   ...
   <xsl:template match="assessment-plan/metadata/location/email-address" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/location/telephone-number" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/location/telephone-number/@type"
                 priority="8">
      <flag in-json="string"
            as-type="string"
            name="type"
   ...
   <xsl:template match="assessment-plan/metadata/location/url" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="url"
             gi="url"
             as-type="uri"
   ...
   <xsl:template match="assessment-plan/metadata/location/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/party/name" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/party/short-name" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="short-name"
             gi="short-name"
   ...
   <xsl:template match="assessment-plan/metadata/party/external-id" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/metadata/party/external-id/@scheme" priority="8">
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="assessment-plan/metadata/party/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/metadata/party/email-address" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="email-address"
             gi="email-address"
             as-type="email"
   ...
   <xsl:template match="assessment-plan/metadata/party/telephone-number" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="telephone-number"
             gi="telephone-number"
             formal-name="Telephone Number">
   ...
   <xsl:template match="assessment-plan/metadata/party/telephone-number/@type"
                 priority="8">
      <flag in-json="string"
            as-type="string"
            name="type"
   ...
   <xsl:template match="assessment-plan/metadata/party/address" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="address" gi="address" formal-name="Address">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">address</xsl:attribute>
   ...
   <xsl:template match="assessment-plan/metadata/party/address/@type" priority="9">
      <flag in-json="string"
            as-type="string"
            name="location-type"
            key="type"
   ...
   <xsl:template match="assessment-plan/metadata/party/address/addr-line" priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="addr-line"
             gi="addr-line"
             formal-name="Address line"
   ...
   <xsl:template match="assessment-plan/metadata/party/address/city" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="city" gi="city" formal-name="City" in-json="SCALAR">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">city</xsl:attribute>
   ...
   <xsl:template match="assessment-plan/metadata/party/address/state" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="state" gi="state" formal-name="State" in-json="SCALAR">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">state</xsl:attribute>
   ...
   <xsl:template match="assessment-plan/metadata/party/address/postal-code" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="postal-code"
             gi="postal-code"
             formal-name="Postal Code"
   ...
   <xsl:template match="assessment-plan/metadata/party/address/country" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="country"
             gi="country"
             formal-name="Country Code"
   ...
   <xsl:template match="assessment-plan/local-definitions" priority="3">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="local-definitions"
         ...
         <xsl:for-each-group select="objectives" group-by="true()">
            <group in-json="ARRAY" key="objectives">
               <xsl:apply-templates select="current-group()">
                  <xsl:with-param name="with-key" select="false()"/>
               </xsl:apply-templates>
            </group>
   ...
   <xsl:template match="assessment-plan/local-definitions/component/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/local-definitions/component/status" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/local-definitions/component/status/@state"
                 priority="7">
      <flag in-json="string"
            as-type="string"
            name="state"
   ...
   <xsl:template match="assessment-plan/local-definitions/user/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/local-definitions/user/short-name" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="short-name"
             gi="short-name"
   ...
   <xsl:template match="assessment-plan/local-definitions/user/description" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="assessment-plan/local-definitions/user/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/local-definitions/objectives/description"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/local-definitions/objectives/link/text"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/local-definitions/objectives/part/title"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/local-definitions/objectives/part/prose"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
   ...
   <xsl:template match="assessment-plan/local-definitions/objectives/part/link/text"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/local-definitions/objectives/assessment-method"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
         ...
         <xsl:apply-templates select="@method-uuid"/>
      </field>
   </xsl:template>
   <xsl:template match="assessment-plan/local-definitions/objectives/assessment-method/@method-uuid"
                 priority="8">
      <flag in-json="string"
            as-type="uuid"
            name="method-uuid"
   ...
   <xsl:template match="assessment-plan/terms-and-conditions" priority="3">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/terms-and-conditions/part/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/terms-and-conditions/part/prose" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
             gi="prose"
   ...
   <xsl:template match="assessment-plan/reviewed-controls/description" priority="4">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="assessment-plan/reviewed-controls/link/text" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-subject/description" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="assessment-plan/assessment-subject/link/text" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-subject/include-all" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="include-all"
             gi="include-all"
   ...
   <xsl:template match="assessment-plan/assessment-subject/include-subject/subject"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="subject"
   ...
   <xsl:template match="assessment-plan/assessment-subject/include-subject/subject/@uuid-ref"
                 priority="10">
      <flag in-json="string"
            as-type="uuid"
            name="uuid-ref"
   ...
   <xsl:template match="assessment-plan/assessment-subject/exclude-subject/subject"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="subject"
   ...
   <xsl:template match="assessment-plan/assessment-subject/exclude-subject/subject/@uuid-ref"
                 priority="9">
      <flag in-json="string"
            as-type="uuid"
            name="uuid-ref"
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools" priority="4">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/title"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/description"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/purpose"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="purpose"
             gi="purpose"
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/link/text"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/status"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="status" gi="status" formal-name="Status">
         <xsl:if test="$with-key">
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/status/@state"
                 priority="8">
      <flag in-json="string"
            as-type="string"
            name="state"
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/responsible-role/link/text"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-assets/tools/component/protocol/title"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/assessment-assets/origination/title"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/assessment-assets/origination/description"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-assets/origination/link/text"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-assets/link/text" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-assets/part/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-assets/part/prose" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="prose"
             as-type="markup-multiline"
             gi="prose"
   ...
   <xsl:template match="assessment-plan/assessment-assets/part/link/text" priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-activity/title" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-activity/description" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="assessment-plan/assessment-activity/origination/title"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/assessment-activity/origination/description"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/origination/link/text"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/link/text" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/@uuid" priority="7">
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/title" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/description"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/origination/title"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/origination/description"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/origination/link/text"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/link/text" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/description"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/link/text"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="control-selection"
                gi="control-selection"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection/description"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection/link/text"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection/include-all"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="include-all"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection/include-control"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="select-control-by-id"
                gi="include-control"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection/include-control/statement-id"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <field name="statement-id"
             gi="statement-id"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection/exclude-control"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="select-control-by-id"
                gi="exclude-control"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-selection/exclude-control/statement-id"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <field name="statement-id"
             gi="statement-id"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-objective-selection"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="control-objective-selection"
                gi="control-objective-selection"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-objective-selection/description"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-objective-selection/link/text"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/reviewed-controls/control-objective-selection/include-all"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="include-all"
   ...
   <xsl:template match="assessment-plan/assessment-activity/step/responsible-role/link/text"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/description"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/link/text"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="control-selection"
                gi="control-selection"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection/description"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection/link/text"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection/include-all"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="include-all"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection/include-control"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="select-control-by-id"
                gi="include-control"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection/include-control/statement-id"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <field name="statement-id"
             gi="statement-id"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection/exclude-control"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="select-control-by-id"
                gi="exclude-control"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-selection/exclude-control/statement-id"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="statement-id"
             gi="statement-id"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-objective-selection"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <assembly name="control-objective-selection"
                gi="control-objective-selection"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-objective-selection/description"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-objective-selection/link/text"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-activity/reviewed-controls/control-objective-selection/include-all"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="include-all"
   ...
   <xsl:template match="assessment-plan/assessment-activity/responsible-role/link/text"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-action/title" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-action/description" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="assessment-plan/assessment-action/link/text" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing" priority="5">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/on-date" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="on-date"
             gi="on-date"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/on-date/@date"
                 priority="8">
      <flag in-json="string"
            as-type="dateTime-with-timezone"
            name="date"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/within-date-range"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/within-date-range/@start"
                 priority="8">
      <flag in-json="string"
            as-type="dateTime-with-timezone"
            name="start"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/within-date-range/@end"
                 priority="8">
      <flag in-json="string"
            as-type="dateTime-with-timezone"
            name="end"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/at-frequency"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="at-frequency"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/at-frequency/@period"
                 priority="8">
      <flag in-json="number"
   ...
   <xsl:template match="assessment-plan/assessment-action/timing/at-frequency/@unit"
                 priority="8">
      <flag in-json="string"
            as-type="dateTime-with-timezone"
            name="unit"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/@uuid"
                 priority="7">
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/@activity-uuid"
                 priority="7">
      <flag in-json="string"
            as-type="uuid"
            name="activity-uuid"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/title"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/description"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/origination/title"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/origination/description"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/origination/link/text"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/link/text"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/responsible-party/link/text"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/description"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/link/text"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/include-all"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="include-all"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/include-subject/subject"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="subject"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/include-subject/subject/@uuid-ref"
                 priority="15">
      <flag in-json="string"
            as-type="uuid"
            name="uuid-ref"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/include-subject/link/text"
                 priority="15">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/exclude-subject/subject"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="subject"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/exclude-subject/subject/@uuid-ref"
                 priority="14">
      <flag in-json="string"
            as-type="uuid"
            name="uuid-ref"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject/exclude-subject/link/text"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject-placeholder"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject-placeholder/description"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject-placeholder/source"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <field as-type="empty"
             name="source"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject-placeholder/source/@activity-instance-uuid"
                 priority="11">
      <flag in-json="string"
            as-type="uuid"
   ...
   <xsl:template match="assessment-plan/assessment-action/activity-instance/assessment-subject-placeholder/link/text"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
   ...
   <xsl:template match="assessment-plan/task/title" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/task/description" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="assessment-plan/task/link/text" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/task/start" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="start"
             gi="start"
             as-type="dateTime-with-timezone"
   ...
   <xsl:template match="assessment-plan/task/end" priority="5">
      <xsl:param name="with-key" select="true()"/>
      <field name="end"
             gi="end"
             as-type="dateTime-with-timezone"
   ...
   <xsl:template match="assessment-plan/task/activity-instance" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/task/activity-instance/@activity-instance-uuid"
                 priority="7">
      <flag in-json="string"
            as-type="uuid"
            name="activity-instance-uuid"
   ...
   <xsl:template match="assessment-plan/task/activity-instance/link/text" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/task/responsible-party/link/text" priority="9">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/back-matter/resource" priority="5">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/back-matter/resource/@uuid" priority="6">
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="assessment-plan/back-matter/resource/title" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/back-matter/resource/description" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="description"
             gi="description"
   ...
   <xsl:template match="assessment-plan/back-matter/resource/document-id" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="document-id"
             gi="document-id"
             formal-name="Document Identifier">
   ...
   <xsl:template match="assessment-plan/back-matter/resource/document-id/@scheme"
                 priority="8">
      <flag in-json="string"
            as-type="uri"
            name="scheme"
   ...
   <xsl:template match="assessment-plan/back-matter/resource/citation" priority="6">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/back-matter/resource/citation/text" priority="7">
      <xsl:param name="with-key" select="true()"/>
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="assessment-plan/back-matter/resource/rlink" priority="7">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="assessment-plan/back-matter/resource/rlink/@href" priority="8">
      <flag in-json="string"
            as-type="uri-reference"
            name="href"
            key="href"
   ...
   <xsl:template match="assessment-plan/back-matter/resource/base64" priority="6">
      <xsl:param name="with-key" select="true()"/>
      <field name="base64"
             gi="base64"
