...
<!-- Parameter setting 'json-indent=yes' produces JSON indented using the internal serializer-->
   ...
   <xsl:template match="shared-responsibility/component/description"
                  priority="5"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/purpose"
                  priority="5"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/link/text"
                  priority="7"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/responsible-role/link/text"
                  priority="9"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/protocol/title"
                  priority="7"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation"
                  priority="6"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/description"
                  priority="7"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/link/text"
                  priority="9"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/set-parameter/value"
                  priority="10"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement"
                  priority="8"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/description"
                  priority="9"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/link/text"
                  priority="11"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/set-parameter/value"
                  priority="12"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/responsible-role/link/text"
                  priority="13"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/provided/description"
                  priority="11"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/provided/link/text"
                  priority="13"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/provided/responsible-role/link/text"
                  priority="15"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/responsibility/description"
                  priority="11"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/responsibility/link/text"
                  priority="13"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/responsibility/responsible-role/link/text"
                  priority="15"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/inherited/description"
                  priority="11"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/inherited/link/text"
                  priority="13"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/inherited/responsible-role/link/text"
                  priority="15"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/satisfied/description"
                  priority="11"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/satisfied/link/text"
                  priority="13"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/satisfied/responsible-role/link/text"
                  priority="15"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/statement"
                  priority="10"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/statement/description"
                  priority="11"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field in-xml="WITH_WRAPPER"
   ...
   <xsl:template match="shared-responsibility/component/control-implementation/implemented-requirement/statement/link/text"
                  priority="13"
                  xpath-default-namespace="http://csrc.nist.gov/ns/oscal/1.0">
      <xsl:param name="with-key" select="true()"/>
      <field collapsible="no"
