...
<!-- nb A schema and Schematron for the metaschema format should be found nearby. -->
    ...
    <xsl:param name="example-converter-xslt-path" as="xs:string" expand-text="true">../../{$target-format}/convert/{/METASCHEMA/short-name}-{$source-format}-to-{$target-format}-converter.xsl</xsl:param>
