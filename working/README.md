 ...
 * '[FedRAMP](FedRAMP) - prototype heading towards representing FedRAMP spreadsheet as a profile (customization) of a baseline derived from SP800-53: currently, we have a profile calling a copy of SP800-53 (in OSCAL); we are working towards a profile calling an SP800-53 baseline (profile)
