...
<!-- Processing architecture -->
   ...
   <!-- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^ -->
   <!-- METASCHEMA: OSCAL System Security Plan (SSP) Model (version 1.0.0-milestone3) in namespace "http://csrc.nist.gov/ns/oscal/1.0"-->
   <xsl:template match="j:map[@key='system-security-plan']">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:string[@key='uuid'] | j:array[@key='props']/j:map[@key='prop']/j:string[@key='uuid'] | j:array[@key='annotations']/j:map/j:string[@key='uuid'] | j:array[@key='locations']/j:map/j:string[@key='uuid'] | j:array[@key='parties']/j:map/j:string[@key='uuid'] | j:map[@key='diagrams']/j:map/@key | j:map[@key='users']/j:map/@key | j:map[@key='components']/j:map/@key | j:array[@key='protocols']/j:map/j:string[@key='uuid'] | j:array[@key='inventory-items']/j:map/j:string[@key='uuid'] | j:array[@key='implemented-requirements']/j:map/j:string[@key='uuid'] | j:map[@key='by-components']/j:map/j:string[@key='uuid'] | j:map[@key='statements']/j:map/j:string[@key='uuid']"><!-- Cf XML match="system-security-plan/@uuid | prop/@uuid | annotation/@uuid | location/@uuid | party/@uuid | diagram/@uuid | user/@uuid | component/@uuid | protocol/@uuid | inventory-item/@uuid | implemented-requirement/@uuid | by-component/@uuid | statement/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:string[@key='uuid'] | j:array[@key='props']/j:map[@key='prop']/j:string[@key='uuid'] | j:array[@key='annotations']/j:map/j:string[@key='uuid'] | j:array[@key='locations']/j:map/j:string[@key='uuid'] | j:array[@key='parties']/j:map/j:string[@key='uuid'] | j:map[@key='diagrams']/j:map/@key | j:map[@key='users']/j:map/@key | j:map[@key='components']/j:map/@key | j:array[@key='protocols']/j:map/j:string[@key='uuid'] | j:array[@key='inventory-items']/j:map/j:string[@key='uuid'] | j:array[@key='implemented-requirements']/j:map/j:string[@key='uuid'] | j:map[@key='by-components']/j:map/j:string[@key='uuid'] | j:map[@key='statements']/j:map/j:string[@key='uuid']"
   ...
   <xsl:template match="j:array[@key='links']/j:map/j:string[@key='href'] | j:map[@key='import-profile']/j:string[@key='href']"><!-- Cf XML match="link/@href | import-profile/@href" -->
      <flag in-json="string"
   ...
   <xsl:template match="j:array[@key='links']/j:map/j:string[@key='href'] | j:map[@key='import-profile']/j:string[@key='href']"
                 mode="keep-value-property"
                 priority="8"><!-- Not keeping the flag here. --></xsl:template>
   ...
   <xsl:template match="j:map[@key='responsible-parties']/j:map/@key | j:map[@key='responsible-roles']/j:map/@key"
                 mode="keep-value-property"
                 priority="6"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="(j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'] | j:array[@key='party-uuids']/j:string[@key='party-uuid'])">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="j:map[@key='system-characteristics']">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-characteristics" -->
   ...
   <xsl:template match="j:array[@key='system-ids']/j:map[@key='system-id']">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="j:array[@key='system-ids']/j:map[@key='system-id']/j:string[@key='identifier-type']"><!-- Cf XML match="system-id/@identifier-type" -->
      <flag in-json="string"
            as-type="uri"
   ...
   <xsl:template match="j:array[@key='system-ids']/j:map[@key='system-id']/j:string[@key='identifier-type']"
                 mode="keep-value-property"
                 priority="6"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='system-information']">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-information" -->
   ...
   <xsl:template match="j:map[@key='security-impact-level']">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="security-impact-level" -->
   ...
   <xsl:template match="j:map[@key='authorization-boundary']">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="authorization-boundary" -->
   ...
   <xsl:template match="j:map[@key='network-architecture']">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="network-architecture" -->
   ...
   <xsl:template match="j:map[@key='system-implementation']">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-implementation" -->
   ...
   <xsl:template match="(@key | @key | j:array[@key='role-ids']/j:string[@key='role-id'] | @key | @key | @key | @key | @key | @key | @key | @key | @key | @key | @key | @key | @key | @key)">
      <xsl:param name="with-key" select="true()"/>
   ...
   <xsl:template match="j:map[@key='implemented-components']/j:map/@key | j:map[@key='by-components']/j:map/@key"><!-- Cf XML match="implemented-component/@component-uuid | by-component/@component-uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="component-uuid"
            key="component-uuid"
   ...
   <xsl:template match="j:map[@key='implemented-components']/j:map/@key | j:map[@key='by-components']/j:map/@key"
                 mode="keep-value-property"
                 priority="8"><!-- Not keeping the flag here. --></xsl:template>
   ...
   <xsl:template match="j:map[@key='parameter-settings']/j:map/@key"><!-- Cf XML match="set-parameter/@param-id" -->
      <flag in-json="string"
            as-type="NCName"
            name="param-id"
            key="param-id"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:string[@key='title']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:string[@key='published']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/published" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:string[@key='last-modified']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/last-modified" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:string[@key='version']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/version" -->
      <field name="version"
             gi="version"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:string[@key='oscal-version']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/oscal-version" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']/j:array[@key='revisions']/j:map"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions/revision" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']/j:array[@key='revisions']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions/revision/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
             formal-name="Document Title"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']/j:array[@key='revisions']/j:map/j:string[@key='published']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions/revision/published" -->
      <field name="published"
             gi="published"
             as-type="dateTime-with-timezone"
             formal-name="Publication Timestamp"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']/j:array[@key='revisions']/j:map/j:string[@key='last-modified']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions/revision/last-modified" -->
      <field name="last-modified"
             gi="last-modified"
             as-type="dateTime-with-timezone"
             formal-name="Last Modified Timestamp"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']/j:array[@key='revisions']/j:map/j:string[@key='version']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions/revision/version" -->
      <field name="version"
             gi="version"
             formal-name="Document Version"
             in-json="SCALAR">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']/j:array[@key='revisions']/j:map/j:string[@key='oscal-version']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions/revision/oscal-version" -->
      <field name="oscal-version"
             gi="oscal-version"
             formal-name="OSCAL version"
             in-json="SCALAR">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='revisions']/j:array[@key='revisions']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/revisions/revision/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='document-ids']/j:map[@key='document-id']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/document-id" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='document-ids']/j:map[@key='document-id']/j:string[@key='scheme']"
                 priority="6"><!-- Cf XML match="system-security-plan/metadata/document-id/@scheme" -->
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/role/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:string[@key='short-name']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/role/short-name" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:string[@key='description']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/role/description" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:map[@key='address']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/address" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:map[@key='address']/j:string[@key='type']"
                 priority="7"><!-- Cf XML match="system-security-plan/metadata/location/address/@type" -->
      <flag in-json="string"
            as-type="string"
            name="location-type"
            key="type"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:map[@key='address']/j:array[@key='addr-lines']/j:string[@key='addr-line']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/address/addr-line" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:map[@key='address']/j:string[@key='city']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/address/city" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:map[@key='address']/j:string[@key='state']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/address/state" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:map[@key='address']/j:string[@key='postal-code']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/address/postal-code" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:map[@key='address']/j:string[@key='country']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/address/country" -->
      <field name="country"
             gi="country"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='email-addresses']/j:string[@key='email-address']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/email-address" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='telephone-numbers']/j:map[@key='telephone-number']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/telephone-number" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='telephone-numbers']/j:map[@key='telephone-number']/j:string[@key='type']"
                 priority="8"><!-- Cf XML match="system-security-plan/metadata/location/telephone-number/@type" -->
      <flag in-json="string"
            as-type="string"
            name="type"
            key="type"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='telephone-numbers']/j:map[@key='telephone-number']/j:string[@key='type']"
                 mode="keep-value-property"
                 priority="8"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='urls']/j:string[@key='url']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/url" -->
      <field name="url"
             gi="url"
             as-type="uri"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='locations']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/location/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='name']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/name" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:string[@key='short-name']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/short-name" -->
      <field name="short-name"
             gi="short-name"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='external-ids']/j:map[@key='external-id']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/external-id" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='external-ids']/j:map[@key='external-id']/j:string[@key='scheme']"
                 priority="8"><!-- Cf XML match="system-security-plan/metadata/party/external-id/@scheme" -->
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='email-addresses']/j:string[@key='email-address']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/email-address" -->
      <field name="email-address"
             gi="email-address"
             as-type="email"
             formal-name="Email Address"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='telephone-numbers']/j:map[@key='telephone-number']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/telephone-number" -->
      <field name="telephone-number"
             gi="telephone-number"
             formal-name="Telephone Number">
         <xsl:if test="$with-key">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='telephone-numbers']/j:map[@key='telephone-number']/j:string[@key='type']"
                 priority="8"><!-- Cf XML match="system-security-plan/metadata/party/telephone-number/@type" -->
      <flag in-json="string"
            as-type="string"
            name="type"
            key="type"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='telephone-numbers']/j:map[@key='telephone-number']/j:string[@key='type']"
                 mode="keep-value-property"
                 priority="8"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/((: NOWHERE :))"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/address" -->
      <assembly name="address" gi="address" formal-name="Address">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">address</xsl:attribute>
         </xsl:if>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/((: NOWHERE :))"
                 priority="9"><!-- Cf XML match="system-security-plan/metadata/party/address/@type" -->
      <flag in-json="string"
            as-type="string"
            name="location-type"
            key="type"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/((: NOWHERE :))"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/address/addr-line" -->
      <field name="addr-line"
             gi="addr-line"
             formal-name="Address line"
             in-json="SCALAR">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/((: NOWHERE :))"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/address/city" -->
      <field name="city" gi="city" formal-name="City" in-json="SCALAR">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">city</xsl:attribute>
         </xsl:if>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/((: NOWHERE :))"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/address/state" -->
      <field name="state" gi="state" formal-name="State" in-json="SCALAR">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">state</xsl:attribute>
         </xsl:if>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/((: NOWHERE :))"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/address/postal-code" -->
      <field name="postal-code"
             gi="postal-code"
             formal-name="Postal Code"
             in-json="SCALAR">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/((: NOWHERE :))"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/address/country" -->
      <field name="country"
             gi="country"
             formal-name="Country Code"
             in-json="SCALAR">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:array[@key='parties']/j:map/j:array[@key='member-of-organizations']/j:string[@key='member-of-organization']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/party/member-of-organization" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='metadata']/j:map[@key='responsible-parties']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/metadata/responsible-party/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:string[@key='system-name']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-name" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:string[@key='system-name-short']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-name-short" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:string[@key='description']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:string[@key='date-authorized']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/date-authorized" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:string[@key='security-sensitivity-level']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/security-sensitivity-level" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type" -->
      <assembly name="information-type"
                gi="information-type"
                formal-name="Information Type">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">information-type</xsl:attribute>
         </xsl:if>
         <xsl:apply-templates select="*[@key='uuid']"/>
         <xsl:apply-templates select="*[@key='title']"/>
         <xsl:apply-templates select="*[@key='description']"/>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:string[@key='uuid']"
                 priority="7"><!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
            gi="uuid"
            formal-name="Information Type Universally Unique Identifier">
         <xsl:value-of select="."/>
      </flag>
   </xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:string[@key='uuid']"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:string[@key='title']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:string[@key='description']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:array[@key='categorizations']/j:map"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/categorization" -->
      <assembly name="categorization"
                gi="categorization"
                formal-name="Information Type Categorization">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">categorization</xsl:attribute>
         </xsl:if>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:array[@key='categorizations']/j:map/j:string[@key='system']"
                 priority="9"><!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/categorization/@system" -->
      <flag in-json="string"
            as-type="uri"
            name="system"
            key="system"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:array[@key='categorizations']/j:map/j:string[@key='system']"
                 mode="keep-value-property"
                 priority="9"><!-- Not keeping the flag here. --></xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:array[@key='categorizations']/j:map/j:array[@key='information-type-ids']/j:string[@key='information-type-id']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/categorization/information-type-id" -->
      <field name="information-type-id"
             ...
             in-json="SCALAR">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">information-type-id</xsl:attribute>
         </xsl:if>
         <xsl:apply-templates select="." mode="get-value-property"/>
      </field>
   </xsl:template>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='confidentiality-impact']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/confidentiality-impact" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='confidentiality-impact']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/confidentiality-impact/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='confidentiality-impact']/j:string[@key='base']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/confidentiality-impact/base" -->
      <field name="base"
             gi="base"
             as-type="string"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='confidentiality-impact']/j:string[@key='selected']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/confidentiality-impact/selected" -->
      <field name="selected"
             gi="selected"
             as-type="string"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='confidentiality-impact']/j:string[@key='adjustment-justification']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/confidentiality-impact/adjustment-justification" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='integrity-impact']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/integrity-impact" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='integrity-impact']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/integrity-impact/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='integrity-impact']/j:string[@key='base']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/integrity-impact/base" -->
      <field name="base"
             gi="base"
             as-type="string"
             formal-name="Base Level (Confidentiality, Integrity, or Availability)"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='integrity-impact']/j:string[@key='selected']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/integrity-impact/selected" -->
      <field name="selected"
             gi="selected"
             as-type="string"
             formal-name="Selected Level (Confidentiality, Integrity, or Availability)"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='integrity-impact']/j:string[@key='adjustment-justification']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/integrity-impact/adjustment-justification" -->
      <field name="adjustment-justification"
             gi="adjustment-justification"
             as-type="markup-multiline"
             formal-name="Adjustment Justification"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='availability-impact']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/availability-impact" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='availability-impact']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/availability-impact/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='availability-impact']/j:string[@key='base']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/availability-impact/base" -->
      <field name="base"
             gi="base"
             as-type="string"
             formal-name="Base Level (Confidentiality, Integrity, or Availability)"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='availability-impact']/j:string[@key='selected']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/availability-impact/selected" -->
      <field name="selected"
             gi="selected"
             as-type="string"
             formal-name="Selected Level (Confidentiality, Integrity, or Availability)"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='system-information']/j:array[@key='information-types']/j:map/j:map[@key='availability-impact']/j:string[@key='adjustment-justification']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/system-information/information-type/availability-impact/adjustment-justification" -->
      <field name="adjustment-justification"
             gi="adjustment-justification"
             as-type="markup-multiline"
             formal-name="Adjustment Justification"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='security-impact-level']/j:string[@key='security-objective-confidentiality']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/security-impact-level/security-objective-confidentiality" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='security-impact-level']/j:string[@key='security-objective-integrity']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/security-impact-level/security-objective-integrity" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='security-impact-level']/j:string[@key='security-objective-availability']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/security-impact-level/security-objective-availability" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='status']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/status" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='status']/j:string[@key='state']"
                 priority="5"><!-- Cf XML match="system-security-plan/system-characteristics/status/@state" -->
      <flag in-json="string"
            as-type="string"
            name="state"
            key="state"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='authorization-boundary']/j:string[@key='description']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/authorization-boundary/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='authorization-boundary']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/authorization-boundary/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='authorization-boundary']/j:map[@key='diagrams']/j:map/j:string[@key='description']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/authorization-boundary/diagram/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='authorization-boundary']/j:map[@key='diagrams']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/authorization-boundary/diagram/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='authorization-boundary']/j:map[@key='diagrams']/j:map/j:string[@key='caption']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/authorization-boundary/diagram/caption" -->
      <field name="caption"
             gi="caption"
             as-type="markup-line"
             formal-name="Caption"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='authorization-boundary']/j:map[@key='diagrams']/j:map/j:string[@key='remarks']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/authorization-boundary/diagram/remarks" -->
      <field name="remarks"
             gi="remarks"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='authorization-boundary']/j:string[@key='remarks']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/authorization-boundary/remarks" -->
      <field name="remarks"
             gi="remarks"
             as-type="markup-multiline"
             formal-name="remarks field"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='network-architecture']/j:string[@key='description']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/network-architecture/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='network-architecture']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/network-architecture/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='network-architecture']/j:map[@key='diagrams']/j:map/j:string[@key='description']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/network-architecture/diagram/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Diagram Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='network-architecture']/j:map[@key='diagrams']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/network-architecture/diagram/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='network-architecture']/j:map[@key='diagrams']/j:map/j:string[@key='caption']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/network-architecture/diagram/caption" -->
      <field name="caption"
             gi="caption"
             as-type="markup-line"
             formal-name="Caption"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='network-architecture']/j:map[@key='diagrams']/j:map/j:string[@key='remarks']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/network-architecture/diagram/remarks" -->
      <field name="remarks"
             gi="remarks"
             as-type="markup-multiline"
             formal-name="remarks field"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='data-flow']/j:string[@key='description']"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/data-flow/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='data-flow']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/data-flow/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='data-flow']/j:map[@key='diagrams']/j:map/j:string[@key='description']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/data-flow/diagram/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Diagram Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='data-flow']/j:map[@key='diagrams']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/data-flow/diagram/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='data-flow']/j:map[@key='diagrams']/j:map/j:string[@key='caption']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/data-flow/diagram/caption" -->
      <field name="caption"
             gi="caption"
             as-type="markup-line"
             formal-name="Caption"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='data-flow']/j:map[@key='diagrams']/j:map/j:string[@key='remarks']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/data-flow/diagram/remarks" -->
      <field name="remarks"
             gi="remarks"
             as-type="markup-multiline"
             formal-name="remarks field"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-characteristics']/j:map[@key='responsible-parties']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-characteristics/responsible-party/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='leveraged-authorizations']/j:map"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/leveraged-authorization" -->
      <assembly name="leveraged-authorization"
                gi="leveraged-authorization"
                formal-name="Leveraged Authorization">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">leveraged-authorization</xsl:attribute>
         </xsl:if>
         <xsl:apply-templates select="*[@key='uuid']"/>
         <xsl:apply-templates select="*[@key='title']"/>
         <xsl:apply-templates select="*[@key='props']"/>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='leveraged-authorizations']/j:map/j:string[@key='uuid']"
                 priority="6"><!-- Cf XML match="system-security-plan/system-implementation/leveraged-authorization/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
            gi="uuid"
            formal-name="Leveraged Authorization Universally Unique Identifier">
         <xsl:value-of select="."/>
      </flag>
   </xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='leveraged-authorizations']/j:map/j:string[@key='uuid']"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='leveraged-authorizations']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/leveraged-authorization/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
             formal-name="title field"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='leveraged-authorizations']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/leveraged-authorization/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='leveraged-authorizations']/j:map/j:string[@key='party-uuid']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/leveraged-authorization/party-uuid" -->
      <field name="party-uuid"
             gi="party-uuid"
             as-type="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='leveraged-authorizations']/j:map/j:string[@key='date-authorized']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/leveraged-authorization/date-authorized" -->
      <field name="date-authorized"
             gi="date-authorized"
             as-type="date"
             formal-name="System Authorization Date"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='users']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/user/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='users']/j:map/j:string[@key='short-name']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/user/short-name" -->
      <field name="short-name"
             gi="short-name"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='users']/j:map/j:string[@key='description']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/user/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='users']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/user/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='users']/j:map/j:array[@key='authorized-privileges']/j:map/j:string[@key='title']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/user/authorized-privilege/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
             formal-name="title field"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='users']/j:map/j:array[@key='authorized-privileges']/j:map/j:string[@key='description']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/user/authorized-privilege/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/component/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:string[@key='description']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/component/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:string[@key='purpose']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/component/purpose" -->
      <field name="purpose"
             gi="purpose"
             as-type="markup-line"
             formal-name="Purpose"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/component/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:map[@key='status']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/component/status" -->
      <assembly name="status" gi="status" formal-name="Status">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">status</xsl:attribute>
         </xsl:if>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:map[@key='status']/j:string[@key='state']"
                 priority="7"><!-- Cf XML match="system-security-plan/system-implementation/component/status/@state" -->
      <flag in-json="string"
            as-type="string"
            name="state"
            key="state"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/component/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:map[@key='components']/j:map/j:array[@key='protocols']/j:map/j:string[@key='title']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/component/protocol/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
             formal-name="title field"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='inventory-items']/j:map/j:string[@key='description']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/inventory-item/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='inventory-items']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/inventory-item/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='inventory-items']/j:map/j:map[@key='responsible-parties']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/inventory-item/responsible-party/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='inventory-items']/j:map/j:map[@key='implemented-components']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/inventory-item/implemented-component/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='system-implementation']/j:array[@key='inventory-items']/j:map/j:map[@key='implemented-components']/j:map/j:map[@key='responsible-parties']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/system-implementation/inventory-item/implemented-component/responsible-party/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:string[@key='description']"
                 priority="4">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='parameter-settings']/j:map/j:array[@key='values']/j:string[@key='value']"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/set-parameter/value" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:string[@key='description']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Control Implementation Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='parameter-settings']/j:map/j:array[@key='values']/j:string[@key='value']"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/set-parameter/value" -->
      <field name="parameter-value"
             gi="value"
             as-type="string"
             formal-name="Parameter Value"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']"
                 priority="8">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:string[@key='description']"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/provided" -->
      <assembly name="provided"
                gi="provided"
                formal-name="Provided Control Implementation">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">provided</xsl:attribute>
         </xsl:if>
         <xsl:apply-templates select="*[@key='uuid']"/>
         <xsl:apply-templates select="*[@key='description']"/>
         <xsl:apply-templates select="*[@key='props']"/>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:string[@key='uuid']"
                 priority="11"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/provided/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
            gi="uuid"
            formal-name="Provided Universally Unique Identifier">
         <xsl:value-of select="."/>
      </flag>
   </xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:string[@key='uuid']"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:string[@key='description']"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/provided/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/provided/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="15">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/provided/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/responsibility" -->
      <assembly name="responsibility"
                gi="responsibility"
                formal-name="Control Implementation Responsibility">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">responsibility</xsl:attribute>
         </xsl:if>
         <xsl:apply-templates select="*[@key='uuid']"/>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:string[@key='uuid']"
                 priority="11"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/responsibility/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
            gi="uuid"
            formal-name="Responsibility Universally Unique Identifier">
         <xsl:value-of select="."/>
      </flag>
   </xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:string[@key='uuid']"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:string[@key='provided-uuid']"
                 priority="11"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/responsibility/@provided-uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="provided-uuid"
            key="provided-uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:string[@key='description']"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/responsibility/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/responsibility/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="15">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/export/responsibility/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/inherited" -->
      <assembly name="inherited"
                gi="inherited"
                formal-name="Inherited Control Implementation">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">inherited</xsl:attribute>
         </xsl:if>
         <xsl:apply-templates select="*[@key='uuid']"/>
         <xsl:apply-templates select="*[@key='provided-uuid']"/>
         <xsl:apply-templates select="*[@key='description']"/>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:string[@key='uuid']"
                 priority="10"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/inherited/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
            gi="uuid"
            formal-name="Inherited Universally Unique Identifier">
         <xsl:value-of select="."/>
      </flag>
   </xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:string[@key='uuid']"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:string[@key='provided-uuid']"
                 priority="10"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/inherited/@provided-uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="provided-uuid"
            key="provided-uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:string[@key='description']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/inherited/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/inherited/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/inherited/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map"
                 priority="9">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/satisfied" -->
      <assembly name="satisfied"
                gi="satisfied"
                formal-name="Satisfied Control Implementation Responsibility">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">satisfied</xsl:attribute>
         </xsl:if>
         <xsl:apply-templates select="*[@key='uuid']"/>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:string[@key='uuid']"
                 priority="10"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/satisfied/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
            gi="uuid"
            formal-name="Satisfied Universally Unique Identifier">
         <xsl:value-of select="."/>
      </flag>
   </xsl:template>
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:string[@key='uuid']"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:string[@key='responsibility-uuid']"
                 priority="10"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/satisfied/@responsibility-uuid" -->
      <flag in-json="string"
            as-type="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:string[@key='description']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/satisfied/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/satisfied/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/satisfied/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/by-component/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:string[@key='description']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Control Implementation Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='parameter-settings']/j:map/j:array[@key='values']/j:string[@key='value']"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/set-parameter/value" -->
      <field name="parameter-value"
             gi="value"
             as-type="string"
             formal-name="Parameter Value"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']"
                 priority="10">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export" -->
      <assembly name="export" gi="export" formal-name="Export">
         <xsl:if test="$with-key">
            <xsl:attribute name="key">export</xsl:attribute>
         </xsl:if>
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:string[@key='description']"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Control Implementation Export Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/provided" -->
      <assembly name="provided"
                gi="provided"
                formal-name="Provided Control Implementation">
         <xsl:if test="$with-key">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:string[@key='uuid']"
                 priority="13"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/provided/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:string[@key='description']"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/provided/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Provided Control Implementation Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="15">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/provided/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='provided']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="17">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/provided/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/responsibility" -->
      <assembly name="responsibility"
                gi="responsibility"
                formal-name="Control Implementation Responsibility">
         <xsl:if test="$with-key">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:string[@key='uuid']"
                 priority="13"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/responsibility/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:string[@key='provided-uuid']"
                 priority="13"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/responsibility/@provided-uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="provided-uuid"
            key="provided-uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:string[@key='description']"
                 priority="13">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/responsibility/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Control Implementation Responsibility Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="15">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/responsibility/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='export']/j:array[@key='responsibilities']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="17">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/export/responsibility/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/inherited" -->
      <assembly name="inherited"
                gi="inherited"
                formal-name="Inherited Control Implementation">
         <xsl:if test="$with-key">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:string[@key='uuid']"
                 priority="12"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/inherited/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:string[@key='provided-uuid']"
                 priority="12"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/inherited/@provided-uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="provided-uuid"
            key="provided-uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:string[@key='description']"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/inherited/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Inherited Control Implementation Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/inherited/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='inherited']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="16">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/inherited/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map"
                 priority="11">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/satisfied" -->
      <assembly name="satisfied"
                gi="satisfied"
                formal-name="Satisfied Control Implementation Responsibility">
         <xsl:if test="$with-key">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:string[@key='uuid']"
                 priority="12"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/satisfied/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:string[@key='responsibility-uuid']"
                 priority="12"><!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/satisfied/@responsibility-uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="responsibility-uuid"
            key="responsibility-uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:string[@key='description']"
                 priority="12">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/satisfied/description" -->
      <field name="description"
             gi="description"
             as-type="markup-multiline"
             formal-name="Satisfied Control Implementation Responsibility Description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/satisfied/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:array[@key='satisfied']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="16">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/satisfied/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='control-implementation']/j:array[@key='implemented-requirements']/j:map/j:map[@key='statements']/j:map/j:map[@key='by-components']/j:map/j:map[@key='responsible-roles']/j:map/j:array[@key='links']/j:map/j:string[@key='text']"
                 priority="14">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/control-implementation/implemented-requirement/statement/by-component/responsible-role/link/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
             formal-name="Link Text"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map"
                 priority="5">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:string[@key='uuid']"
                 priority="6"><!-- Cf XML match="system-security-plan/back-matter/resource/@uuid" -->
      <flag in-json="string"
            as-type="uuid"
            name="uuid"
            key="uuid"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:string[@key='title']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/title" -->
      <field name="title"
             gi="title"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:string[@key='description']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/description" -->
      <field name="description"
             gi="description"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:array[@key='document-ids']/j:map[@key='document-id']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/document-id" -->
      <field name="document-id"
             gi="document-id"
             formal-name="Document Identifier">
         <xsl:if test="$with-key">
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:array[@key='document-ids']/j:map[@key='document-id']/j:string[@key='scheme']"
                 priority="8"><!-- Cf XML match="system-security-plan/back-matter/resource/document-id/@scheme" -->
      <flag in-json="string"
            as-type="uri"
            name="scheme"
            key="scheme"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:map[@key='citation']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/citation" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:map[@key='citation']/j:string[@key='text']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/citation/text" -->
      <field name="text"
             gi="text"
             as-type="markup-line"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:map[@key='citation']/j:map[@key='biblio']"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/citation/biblio" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:array[@key='rlinks']/j:map"
                 priority="7">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/rlink" -->
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:array[@key='rlinks']/j:map/j:string[@key='href']"
                 priority="8"><!-- Cf XML match="system-security-plan/back-matter/resource/rlink/@href" -->
      <flag in-json="string"
            as-type="uri-reference"
            name="href"
            key="href"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:map[@key='base64']"
                 priority="6">
      <xsl:param name="with-key" select="true()"/>
      <!-- Cf XML match="system-security-plan/back-matter/resource/base64" -->
      <field name="base64"
             gi="base64"
   ...
   <xsl:template match="j:map[@key='system-security-plan']/j:map[@key='back-matter']/j:array[@key='resources']/j:map/j:map[@key='base64']/j:string[@key='filename']"
                 priority="7"><!-- Cf XML match="system-security-plan/back-matter/resource/base64/@filename" -->
      <flag in-json="string"
            as-type="uri-reference"
            name="filename"
            key="filename"
