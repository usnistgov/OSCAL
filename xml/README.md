...
- [XML Schema for OSCAL Models](#xml-schema-for-oscal-models)
    - [Validating OSCAL Content](#validating-oscal-content)
- [OSCAL JSON to XML Converters](#oscal-json-to-xml-converters)
    - [Converting OSCAL Content](#converting-oscal-content)
...
The follwoing example uses **Saxon HE** to convert an OSCAL catalog JSON file to XML using one of the NIST-provided [JSON to XML XSLT converters](convert). This example assumes that Java 8+ and Saxon-HE have already been installed.
...
The [online documentation](http://www.saxonica.com/documentation/#!using-xsl/commandline) for *Saxon* provides more information on the commandline arguments.
