...
| [Lula](https://github.com/defenseunicorns/lula) | Defense Unicorns | Lula is a Command Line Interface tool for performing the automated validation of controls against live Kubernetes clusters or static-manifests using OSCAL Component Definitions as a source of control-to-validation mapping. | open source |
