---
title: "OSCAL Component Definition Model v1.0.1 JSON Format Metaschema Reference"
heading: "Component Definition Model v1.0.1 Model JSON Metaschema Reference"
weight: 40
...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.1//src/metaschema/oscal_component-definition_metaschema.xml) for this [model](/concepts/layer/implementation/component-definition/).
