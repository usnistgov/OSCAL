...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.5//src/metaschema/oscal_assessment-plan_metaschema.xml) for this [model](/concepts/layer/assessment/assessment-plan/).
