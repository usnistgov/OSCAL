---
title: "OSCAL Catalog Model v1.0.5 JSON Format Metaschema Reference"
heading: "Catalog Model v1.0.5 Model JSON Metaschema Reference"
weight: 40
...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.5//src/metaschema/oscal_catalog_metaschema.xml) for this [model](/concepts/layer/control/catalog/).
