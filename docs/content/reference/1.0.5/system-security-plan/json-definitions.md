---
title: "OSCAL System Security Plan Model v1.0.5 JSON Format Metaschema Reference"
heading: "System Security Plan Model v1.0.5 Model JSON Metaschema Reference"
weight: 40
...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.5//src/metaschema/oscal_ssp_metaschema.xml) for this [model](/concepts/layer/implementation/ssp/).
