...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-rules//src/metaschema/oscal_ssp_metaschema.xml) for this [model](/concepts/layer/implementation/ssp/).
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ssp/by-component/rule-implementations" class="toc2 name">rule-implementation</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-ssp/by-component/rule-implementation">Switch to XML</a></div>
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ssp/statement/rule-implementations" class="toc2 name">rule-implementation</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-ssp/statement/rule-implementation">Switch to XML</a></div>
                     <p class="formal-name">Rule Implementation</p>
                  </div>
                  <div class="body">
                     <p><span class="usa-tag">group as</span> <code class="name">rule-implementations</code></p>
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ssp/system-implementation/rules" class="toc2 name">rule</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-ssp/system-implementation/rule">Switch to XML</a></div>
                     <p class="formal-name">Rule Definition</p>
                  </div>
                  <div class="body">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ssp/system-implementation/tests" class="toc2 name">test</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-ssp/system-implementation/test">Switch to XML</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ssp/system-implementation/testing-scenarios" class="toc2 name">testing-scenario</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-ssp/system-implementation/testing-scenario">Switch to XML</a></div>
