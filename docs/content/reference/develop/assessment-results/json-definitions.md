...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-ci-diagrams-issue-1678//src/metaschema/oscal_assessment-results_metaschema.xml) for this [model](/concepts/layer/assessment/assessment-results/).
