...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-metadata-actions-assembly//src/metaschema/oscal_poam_metaschema.xml) for this [model](/concepts/layer/assessment/poam/).
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../xml-definitions/#/assembly/oscal-poam/local-definitions/assessment-assets">Switch to XML</a></div>
                     <p class="formal-name">Assessment Assets</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
