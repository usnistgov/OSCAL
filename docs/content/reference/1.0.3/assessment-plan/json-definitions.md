---
title: "OSCAL Assessment Plan Model v1.0.3 JSON Format Metaschema Reference"
heading: "Assessment Plan Model v1.0.3 Model JSON Metaschema Reference"
weight: 40
...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.3//src/metaschema/oscal_assessment-plan_metaschema.xml) for this [model](/concepts/layer/assessment/assessment-plan/).
