---
title: "OSCAL Plan of Action and Milestones Model v1.0.0 JSON Format Metaschema Reference"
heading: Plan of Action and Milestones Model v1.0.0 Model JSON Metaschema Reference
weight: 40
sidenav:
...
The following is a reference for the JSON object definitions derived from this model's [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.0//src/metaschema/oscal_poam_metaschema.xml).
