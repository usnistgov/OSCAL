---
title: "OSCAL Assessment Results Model v1.0.0-rc2 XML Format Metaschema Reference"
heading: Assessment Results Model v1.0.0-rc2 XML Metaschema Reference
weight: 80
sidenav:
...
The following is a reference for the XML element and attribute types derived from this model's [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.0-rc2//src/metaschema/oscal_assessment-results_metaschema.xml).
...
<div xmlns="http://www.w3.org/1999/xhtml" class="xml-definition">
   ...
   <p><span class="usa-tag">XML Schema</span> <a href="/artifacts/xml/schema/oscal_assessment-results_schema.xsd">oscal_assessment-results_schema.xsd</a></p>
   <p><span class="usa-tag">JSON to XML converter</span> <a href="/artifacts/xml/convert/oscal_assessment-results_json-to-xml-converter.xsl">oscal_assessment-results_json-to-xml-converter.xsl</a> <a href="https://github.com/usnistgov/OSCAL/tree/main/xml#converting-oscal-json-content-to-xml">(How do I use the converter to convert OSCAL JSON to XML?)</a></p>
                  ...
                  <div class="body">
                     <div class="remarks-group usa-prose">
                        <details open="open">
                           <summary class="subhead">Remarks</summary>
                           <div class="remarks">
                              <p>Identifies the roles, and optionally the parties, associated with this assessment
                                 activity.</p>
                           </div>
                        </details>
                     </div>
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/uuid">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/metadata">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/import-ap">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/local-definitions">Switch to JSON</a></div>
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 ...
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/local-definitions/objectives-and-methods">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/assessment-results/local-definitions/activity" class="toc3 name">activity</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/local-definitions/activities">Switch to JSON</a></div>
                                 <p class="formal-name">Activity</p>
                              </div>
                              <div class="body">
                           ...
                           <div class="model-entry definition field">
                              <div class="instance-header">
                                 ...
                                 <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/local-definitions/remarks">Switch to JSON</a></div>
                                 <p class="formal-name">Remarks</p>
                              </div>
                              <div class="body">
                                 <p class="definition-link"><a href="#/field/oscal-metadata/remarks">See definition</a></p>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/assessment-results/result" class="toc2 name">result</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/results">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/assessment-results/back-matter">Switch to JSON</a></div>
                              ...
                              <div class="body">
                                 ...
                                 <details open="open">
                                    ...
                                    <div class="model assembly-model">
                                       ...
                                       <div class="model-entry definition define-assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-metadata/back-matter/resource/citation/biblio" class="toc4 name">biblio</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-metadata/back-matter/resources/citation/biblio">Switch to JSON</a></div>
   ...
   <div class="model-entry definition define-flag">
      <div class="definition-header">
         <h1 id="/flag/oscal-implementation-common/component-type" class="toc1 name">component-type</h1>
         <p class="type"><a href="/reference/datatypes/#string">string</a></p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/flag/oscal-implementation-common/component-type">Switch to JSON</a></div>
   ...
   <div class="model-entry definition define-flag">
      <div class="definition-header">
         <h1 id="/flag/oscal-implementation-common/control-id" class="toc1 name">control-id</h1>
         <p class="type"><a href="/reference/datatypes/#ncname">NCName</a></p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/flag/oscal-implementation-common/control-id">Switch to JSON</a></div>
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/uuid">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-line">markup-line</a></p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/title">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/description">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/finding/prop" class="toc2 name">property</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/props">Switch to JSON</a></div>
                     <p class="formal-name">Property</p>
                  </div>
                  <div class="body">
                     <p><span class="usa-tag">use name</span> <code class="name">prop</code></p>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/finding/link" class="toc2 name">link</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/links">Switch to JSON</a></div>
                     <p class="formal-name">Link</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/finding/origin" class="toc2 name">origin</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/origins">Switch to JSON</a></div>
                     <p class="formal-name">Origin</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/target">Switch to JSON</a></div>
                  ...
                  <div class="body">
                     ...
                     <div class="remarks-group usa-prose">
                        <details open="open">
                           <summary class="subhead">Remarks</summary>
                           <div class="remarks">
                              <p>While use of <code>target</code> is optional, it is recommended to use this object to identify the target of the finding
               ...
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/implementation-statement-uuid">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/finding/related-observation" class="toc2 name">related-observation</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/related-observations">Switch to JSON</a></div>
                  ...
                  <div class="body">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition define-flag">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/finding/related-observation/observation-uuid" class="toc3 name">observation-uuid</h3>
                                 <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/related-observations/observation-uuid">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/finding/associated-risk" class="toc2 name">associated-risk</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/related-risks">Switch to JSON</a></div>
                  ...
                  <div class="body">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition define-flag">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/finding/associated-risk/risk-uuid" class="toc3 name">risk-uuid</h3>
                                 <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/related-risks/risk-uuid">Switch to JSON</a></div>
               ...
               <div class="model-entry definition field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/finding/remarks">Switch to JSON</a></div>
                     <p class="formal-name">Remarks</p>
                  </div>
                  <div class="body">
                     <p class="definition-link"><a href="#/field/oscal-metadata/remarks">See definition</a></p>
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-assessment-common/finding-target/id-ref" class="toc2 name">id-ref</h2>
                     <p class="type"><a href="/reference/datatypes/#ncname">NCName</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-assessment-common/finding-target/id-ref">Switch to JSON</a></div>
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/import-ap">Switch to JSON</a></div>
         <p class="formal-name">Import Assessment Plan</p>
      </div>
      <div class="body">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uri-reference">uri-reference</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/import-ap/href">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/import-ap/remarks">Switch to JSON</a></div>
                     <p class="formal-name">Remarks</p>
                  </div>
                  <div class="body">
                     <p class="definition-link"><a href="#/field/oscal-metadata/remarks">See definition</a></p>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition flag">
                  ...
                  <div class="body">
                     ...
                     <p class="definition-link"><a href="#/flag/oscal-implementation-common/control-id">See definition</a></p>
                  </div>
               </div>
            </div>
         </details>
                        ...
                        <div class="constraint">
                           ...
                           <ul>
                              ...
                              <li><strong>UNKNOWN</strong>: This is only for use when converting historic content to OSCAL, where the conversion
                                 process cannot initially identify the appopriate method(s).</li>
                              </ul>
                        </div>
                        </details>
                  </div>
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-assessment-common/origin-actor/uuid-ref" class="toc2 name">uuid-ref</h2>
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-assessment-common/origin-actor/uuid-ref">Switch to JSON</a></div>
                     <p class="formal-name">Actor UUID Reference</p>
                  </div>
                  <div class="body">
   ...
   <div class="model-entry definition define-assembly">
      <div class="definition-header">
         ...
         <p class="type">assembly<br class="br" /> </p>
         <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result">Switch to JSON</a></div>
         <p class="formal-name">Assessment Result</p>
      </div>
      <div class="body">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/uuid">Switch to JSON</a></div>
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-line">markup-line</a></p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/title">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/description">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#datetime-with-timezone">dateTime-with-timezone</a></p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/start">Switch to JSON</a></div>
               ...
               <div class="model-entry definition define-field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#datetime-with-timezone">dateTime-with-timezone</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/end">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/result/link" class="toc2 name">link</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/links">Switch to JSON</a></div>
                     <p class="formal-name">Link</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/local-definitions">Switch to JSON</a></div>
                     <p class="formal-name">Local Definitions</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Used to define data objects that are used in the assessment plan, that do not appear
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/result/local-definitions/component" class="toc3 name">component</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/local-definitions/components">Switch to JSON</a></div>
                                 <p class="formal-name">Component</p>
                              </div>
                              <div class="body">
                                 <p><span class="usa-tag">use name</span> <code class="name">component</code></p>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/result/local-definitions/inventory-item" class="toc3 name">inventory-item</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/local-definitions/inventory-items">Switch to JSON</a></div>
                                 <p class="formal-name">Inventory Item</p>
                              </div>
                              <div class="body">
                                 <div class="remarks-group usa-prose">
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/result/local-definitions/user" class="toc3 name">user</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/local-definitions/users">Switch to JSON</a></div>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 ...
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/local-definitions/assessment-assets">Switch to JSON</a></div>
                                 <p class="formal-name">Assessment Assets</p>
                              </div>
                              <div class="body">
                                 <div class="remarks-group usa-prose">
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/result/local-definitions/assessment-task" class="toc3 name">assessment-task</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/local-definitions/tasks">Switch to JSON</a></div>
                                 <p class="formal-name">Task</p>
                              </div>
                              <div class="body">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/reviewed-controls">Switch to JSON</a></div>
                     <p class="formal-name">Reviewed Controls and Control Objectives</p>
                  </div>
                  <div class="body">
                     <div class="remarks-group usa-prose">
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/result/attestation" class="toc2 name">attestation</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/attestations">Switch to JSON</a></div>
                  ...
                  <div class="body">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/result/attestation/responsible-party" class="toc3 name">responsible-party</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/attestations/responsible-parties">Switch to JSON</a></div>
                                 <p class="formal-name">Responsible Party</p>
                              </div>
                              <div class="body">
                                 <p class="definition-link"><a href="#/assembly/oscal-metadata/responsible-party">See definition</a></p>
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/result/attestation/part" class="toc3 name">part</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[1 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/attestations/parts">Switch to JSON</a></div>
                                 <p class="formal-name">Assessment Part</p>
                              </div>
                              <div class="body">
                                 <p><span class="usa-tag">use name</span> <code class="name">part</code></p>
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     ...
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log">Switch to JSON</a></div>
                  ...
                  <div class="body">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition define-assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-ar/result/assessment-log/entry" class="toc3 name">entry</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[1 to ∞]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries">Switch to JSON</a></div>
                              ...
                              <div class="body">
                                 ...
                                 <details open="open">
                                    ...
                                    <div class="model assembly-model">
                                       <div class="model-entry definition define-flag">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/uuid" class="toc4 name">uuid</h4>
                                             <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/uuid">Switch to JSON</a></div>
                                 ...
                                 <details open="open">
                                    ...
                                    <div class="model assembly-model">
                                       <div class="model-entry definition define-field">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/title" class="toc4 name">title</h4>
                                             <p class="type"><a href="/reference/datatypes/#markup-line">markup-line</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/title">Switch to JSON</a></div>
                                       ...
                                       <div class="model-entry definition define-field">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/description" class="toc4 name">description</h4>
                                             <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/description">Switch to JSON</a></div>
                                       ...
                                       <div class="model-entry definition define-field">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/start" class="toc4 name">start</h4>
                                             <p class="type"><a href="/reference/datatypes/#datetime-with-timezone">dateTime-with-timezone</a></p>
                                             <p class="occurrence">[1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/start">Switch to JSON</a></div>
                                             <p class="formal-name">Start</p>
                                          </div>
                                          <div class="body">
                                       ...
                                       <div class="model-entry definition define-field">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/end" class="toc4 name">end</h4>
                                             <p class="type"><a href="/reference/datatypes/#datetime-with-timezone">dateTime-with-timezone</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/end">Switch to JSON</a></div>
                                             <p class="formal-name">End</p>
                                          </div>
                                          <div class="body">
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/prop" class="toc4 name">property</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/props">Switch to JSON</a></div>
                                             <p class="formal-name">Property</p>
                                          </div>
                                          <div class="body">
                                             <p><span class="usa-tag">use name</span> <code class="name">prop</code></p>
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/link" class="toc4 name">link</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/links">Switch to JSON</a></div>
                                             <p class="formal-name">Link</p>
                                          </div>
                                          <div class="body">
                                             <div class="remarks-group usa-prose">
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/logged-by" class="toc4 name">logged-by</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/logged-by">Switch to JSON</a></div>
                                             <p class="formal-name">Logged By</p>
                                          </div>
                                          <div class="body">
                                       ...
                                       <div class="model-entry definition assembly">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/related-task" class="toc4 name">related-task</h4>
                                             <p class="type">assembly<br class="br" /> </p>
                                             <p class="occurrence">[0 to ∞]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/related-tasks">Switch to JSON</a></div>
                                             <p class="formal-name">Task Reference</p>
                                          </div>
                                          <div class="body">
                                             <p class="definition-link"><a href="#/assembly/oscal-assessment-common/related-task">See definition</a></p>
                                       ...
                                       <div class="model-entry definition field">
                                          <div class="instance-header">
                                             <h4 id="/assembly/oscal-ar/result/assessment-log/entry/remarks" class="toc4 name">remarks</h4>
                                             <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                                             <p class="occurrence">[0 or 1]</p>
                                             <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/assessment-log/entries/remarks">Switch to JSON</a></div>
                                             <p class="formal-name">Remarks</p>
                                          </div>
                                          <div class="body">
                                             <p class="definition-link"><a href="#/field/oscal-metadata/remarks">See definition</a></p>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/result/observation" class="toc2 name">observation</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/observations">Switch to JSON</a></div>
                     <p class="formal-name">Observation</p>
                  </div>
                  <div class="body">
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/result/risk" class="toc2 name">risk</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[0 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/risks">Switch to JSON</a></div>
               ...
               <div class="model-entry definition assembly">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-ar/result/finding" class="toc2 name">finding</h2>
                     <p class="type">assembly<br class="br" /> </p>
                     <p class="occurrence">[1 to ∞]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/findings">Switch to JSON</a></div>
                     <p class="formal-name">Finding</p>
                  </div>
                  <div class="body">
               ...
               <div class="model-entry definition field">
                  <div class="instance-header">
                     ...
                     <p class="type"><a href="/reference/datatypes/#markup-multiline">markup-multiline</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-ar/result/remarks">Switch to JSON</a></div>
                     <p class="formal-name">Remarks</p>
                  </div>
                  <div class="body">
                     <p class="definition-link"><a href="#/field/oscal-metadata/remarks">See definition</a></p>
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition define-assembly">
                  <div class="instance-header">
                     ...
                     <p class="formal-name">Referened Control Objectives</p>
                  </div>
                  <div class="body">
               ...
               <div class="model-entry definition define-flag">
                  ...
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Uniquely identifies this risk. This UUID may be referenced elsewhere in an OSCAL
                        document when refering to this information. Once assigned, a UUID should be consistantly
                           ...
                           <div class="model-entry definition define-flag">
                              ...
                              <div class="body">
                                 <p class="description"><span class="usa-tag">description</span> Uniquely identifies this mitigating factor. This UUID may be referenced elsewhere
                                    in an OSCAL document when refering to this information. Once assigned, a UUID should
                                    be consistantly used for a given mitigating factor across revisions.</p>
                              </div>
                           </div>
                           <div class="model-entry definition define-flag">
                              <div class="instance-header">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           <div class="model-entry definition define-assembly">
                              ...
                              <div class="body">
                                 <p class="description"><span class="usa-tag">description</span> Identifies the result of a task that occurred as part of executing an assessment
                                    plan or an assessment event that occurred in producing the assessment results.</p>
                                 <details>
                                    <summary>Constraints (2)</summary>
                                    ...
                                    <div class="constraint">
                                       ...
                                       <ul>
                                          ...
                                          <li><strong>remediated</strong>: An activitiy was completed that eliminates the likelihood or impact of this risk.</li>
                                    ...
                                    <div class="model assembly-model">
                                       ...
                                       <div class="model-entry definition define-assembly">
                                          <div class="instance-header">
                                             ...
                                             <p class="formal-name">Action Reference</p>
                                          </div>
                                          <div class="body">
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-assessment-common/select-subject-by-id/uuid-ref" class="toc2 name">uuid-ref</h2>
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-assessment-common/select-subject-by-id/uuid-ref">Switch to JSON</a></div>
                     <p class="formal-name">UUID Reference</p>
                  </div>
                  <div class="body">
      ...
      <div class="body">
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     <h2 id="/assembly/oscal-assessment-common/subject-reference/uuid-ref" class="toc2 name">uuid-ref</h2>
                     <p class="type"><a href="/reference/datatypes/#uuid">uuid</a></p>
                     <p class="occurrence">[0 or 1]</p>
                     <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-assessment-common/subject-reference/uuid-ref">Switch to JSON</a></div>
                     <p class="formal-name">UUID Reference</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> A pointer to a component, inventory-item, location, party, user, or resource using
               ...
               <div class="model-entry definition define-flag">
                  <div class="instance-header">
                     ...
                     <p class="formal-name">Universally Unique Identifier Reference Type</p>
                  </div>
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Used to indicate the type of object pointed to by the <code>uuid-ref</code>.</p>
                     <details>
                        <summary>Constraint (1)</summary>
   ...
   <div class="model-entry definition define-assembly">
      ...
      <div class="body">
         ...
         <details>
            <summary>Constraints (23)</summary>
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition flag">
                  ...
                  <div class="body">
                     <p><span class="usa-tag">use name</span> <code class="name">type</code></p>
                     <p class="definition-link"><a href="#/flag/oscal-implementation-common/component-type">See definition</a></p>
                  </div>
               </div>
            </div>
         </details>
         ...
         <details open="open">
            ...
            <div class="model assembly-model">
               ...
               <div class="model-entry definition define-assembly">
                  ...
                  <div class="body">
                     <p class="description"><span class="usa-tag">description</span> Used to indicate that a task is dependant on another task.</p>
                     <details open="open">
                        <summary>Attribute (1):</summary>
                        <div class="model assembly-model">
                           <div class="model-entry definition define-flag">
                  ...
                  <div class="body">
                     ...
                     <details open="open">
                        ...
                        <div class="model assembly-model">
                           ...
                           <div class="model-entry definition assembly">
                              <div class="instance-header">
                                 <h3 id="/assembly/oscal-assessment-common/task/associated-activity/subject-placeholder" class="toc3 name">subject-placeholder</h3>
                                 <p class="type">assembly<br class="br" /> </p>
                                 <p class="occurrence">[0 or 1]</p>
                                 <div class="crosslink"><a class="usa-button" href="../json-definitions/#/assembly/oscal-assessment-common/task/associated-activities/subject-placeholder">Switch to JSON</a></div>
                                 <p class="formal-name">Assessment Subject Placeholder</p>
                              </div>
                              <div class="body">
                                 <p><span class="usa-tag">use name</span> <code class="name">subject-placeholder</code></p>
                                 <p class="definition-link"><a href="#/assembly/oscal-assessment-common/assessment-subject-placeholder">See definition</a></p>
                              </div>
                           </div>
                           <div class="model-entry definition field">
                              <div class="instance-header">
