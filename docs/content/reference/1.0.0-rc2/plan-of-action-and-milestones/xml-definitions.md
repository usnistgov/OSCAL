...
The following is a reference for the XML element and attribute types derived from this model's [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.0-rc2//src/metaschema/oscal_poam_metaschema.xml).
...
<div xmlns="http://www.w3.org/1999/xhtml" class="xml-definition">
   ...
   <p><span class="usa-tag">XML Schema</span> <a href="/artifacts/xml/schema/oscal_poam_schema.xsd">oscal_poam_schema.xsd</a></p>
   <p><span class="usa-tag">JSON to XML converter</span> <a href="/artifacts/xml/convert/oscal_poam_json-to-xml-converter.xsl">oscal_poam_json-to-xml-converter.xsl</a> <a href="https://github.com/usnistgov/OSCAL/tree/main/xml#converting-oscal-json-content-to-xml">(How do I use the converter to convert OSCAL JSON to XML?)</a></p>
