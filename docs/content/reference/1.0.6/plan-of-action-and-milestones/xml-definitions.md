---
title: "OSCAL Plan of Action and Milestones Model v1.0.6 XML Format Metaschema Reference"
heading: "Plan of Action and Milestones Model v1.0.6 XML Metaschema Reference"
weight: 80
...
The following is a reference for the XML element and attribute types derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.6//src/metaschema/oscal_poam_metaschema.xml) for this [model](/concepts/layer/assessment/poam/).
