---
title: "OSCAL Profile Model v1.0.6 XML Format Metaschema Reference"
heading: "Profile Model v1.0.6 XML Metaschema Reference"
weight: 80
...
The following is a reference for the XML element and attribute types derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/v1.0.6//src/metaschema/oscal_profile_metaschema.xml) for this [model](/concepts/layer/control/profile/).
