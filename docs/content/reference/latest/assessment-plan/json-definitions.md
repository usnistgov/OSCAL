---
title: "OSCAL Assessment Plan Model Development Snapshot JSON Format Metaschema Reference"
heading: Assessment Plan Model Development Snapshot Model JSON Metaschema Reference
weight: 40
sidenav:
...
The following is a reference for the JSON object definitions derived from this model's [metaschema](https://github.com/usnistgov/OSCAL/blob/feature-documentation-redesign-2021-05//src/metaschema/oscal_assessment-plan_metaschema.xml).
