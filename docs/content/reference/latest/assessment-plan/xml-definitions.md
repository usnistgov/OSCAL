---
title: "Assessment Plan Model XML Format Metaschema Reference"
heading: OSCAL Assessment Plan Model XML Metaschema Reference
description: A reference for the XML element and attribute definitions for the OSCAL Assessment Plan model derived from this model's metaschema.
weight: 80
sidenav:
...
<div xmlns="http://www.w3.org/1999/xhtml">
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ap/assessment-plan/assessment-subject">Assembly (reference) <code>assessment-subject</code> - grouped as <code>assessment-subjects</code></li>
         <li id="/assembly/oscal-ap/assessment-plan/assessment-assets">Assembly (reference) <code>assessment-assets</code></li>
         <li id="/assembly/oscal-ap/assessment-plan/task">Assembly (reference) <code>task</code> - grouped as <code>tasks</code></li>
