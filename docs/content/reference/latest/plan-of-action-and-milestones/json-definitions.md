...
<div xmlns="http://www.w3.org/1999/xhtml">
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-poam/plan-of-action-and-milestones/observations">Assembly (reference) <code>observation</code> - grouped as <code>observations</code></li>
         <li id="/assembly/oscal-poam/plan-of-action-and-milestones/risks">Assembly (reference) <code>risk</code> - grouped as <code>risks</code></li>
         <li id="/assembly/oscal-poam/plan-of-action-and-milestones/poam-items">Assembly (reference) <code>poam-item</code> - grouped as <code>poam-items</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         <li id="/assembly/oscal-poam/local-definitions/components">Assembly (reference) <code>system-component</code> - using name <code>component</code> - grouped as <code>components</code></li>
         <li id="/assembly/oscal-poam/local-definitions/inventory-items">Assembly (reference) <code>inventory-item</code> - grouped as <code>inventory-items</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-poam/poam-item/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-poam/poam-item/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-poam/poam-item/origins">Assembly (defined inline) <code>origin</code> - grouped as <code>origins</code></li>
         <li id="/assembly/oscal-poam/poam-item/related-observations">Assembly (defined inline) <code>related-observation</code> - grouped as <code>related-observations</code></li>
         <li id="/assembly/oscal-poam/poam-item/related-risks">Assembly (defined inline) <code>associated-risk</code> - grouped as <code>related-risks</code></li>
