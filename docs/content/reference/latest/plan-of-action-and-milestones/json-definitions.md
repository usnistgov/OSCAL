---
title: "OSCAL Plan of Action and Milestones Model v1.0.3-alpha JSON Format Metaschema Reference"
heading: "Plan of Action and Milestones Model v1.0.3-alpha Model JSON Metaschema Reference"
weight: 40
...
The following is a reference for the JSON object definitions derived from the [metaschema](https://github.com/usnistgov/OSCAL/blob/main//src/metaschema/oscal_poam_metaschema.xml) for this [model](/concepts/layer/assessment/poam/).
