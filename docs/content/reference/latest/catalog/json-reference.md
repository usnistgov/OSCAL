...
<div xmlns="http://www.w3.org/1999/xhtml" class="json-reference">
   ...
   <section class="json-obj">
      <div class="header">
         <div>
            <h1 id="/catalog" class="toc1 head">catalog</h1>CatalogA collection of controls.Catalog Universally Unique IdentifierA globally unique
            identifier for this catalog instance. This UUID should be changed when this document
            is revised.Publication metadataProvides information about the publication and availability
            of the containing document.Document TitleA name given to the document, which may be
            used by a tool for display and navigation.Publication TimestampThe date and time the
            document was published. The date-time value must be formatted according to RFC 3339
            with full time and time zone included.This value represents the point in time when
            the OSCAL document was published. Typically, this date value will be machine generated
            at the time the containing document is published.In some cases, an OSCAL document
            may be derived from some source material in a different format. In such a case, the
            published value should indicate when the OSCAL document was published, not the source
            material. Where necessary, the publication date of the original source material can
            be captured as a named property or custom metadata construct.A publisher of OSCAL
            content can use this data point along with its siblings last-modified and version
            ...
            Back matter including references and resources.Provides a collection of identified
            resource objects that can be referenced by a link with a rel value of "reference"
            and an href value that is a fragment "#" followed by a reference to a reference identifier.
            Other specialized link "rel" values also use this pattern when indicated in that context
            of use.
            
            Catalogs may use one or more group objects to subdivide the control contents of a
            catalog.An OSCAL catalog model provides a structured representation of control information.Catalogs
            may use one or more group objects to subdivide the control contents of a catalog.An
            OSCAL catalog model provides a structured representation of control information.
      ...
      <section class="json-obj">
         <div class="header">
            <div>
               <h2 id="/catalog/uuid" class="toc2 head">uuid</h2>Catalog Universally Unique IdentifierA globally unique identifier for this catalog
      ...
      <section class="json-obj">
         <div class="header">
            <div>
               <h2 id="/catalog/metadata" class="toc2 head">metadata</h2>Publication metadataProvides information about the publication and availability of
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/metadata/title" class="toc3 head">title</h3>Document TitleA name given to the document, which may be used by a tool for display
                  and navigation.
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/metadata/published" class="toc3 head">published</h3>Publication TimestampThe date and time the document was published. The date-time value
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/metadata/last-modified" class="toc3 head">last-modified</h3>Last Modified TimestampThe date and time the document was last modified. The date-time
                  value must be formatted according to RFC 3339 with full time and time zone included.This
                  value represents the point in time when the OSCAL document was last updated, or at
                  the point of creation the creation date. Typically, this date value will be machine
                  generated at time of creation or modification.In some cases, an OSCAL document may
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/metadata/version" class="toc3 head">version</h3>Document VersionA string used to distinguish the current version of the document from
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/metadata/oscal-version" class="toc3 head">oscal-version</h3>OSCAL versionThe OSCAL model version the document was authored against.Indicates the
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/revisions/title" class="toc4 head">title</h4>Document TitleA name given to the document revision, which may be used by a tool for
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/revisions/published" class="toc4 head">published</h4>Publication TimestampThe date and time the document was published. The date-time value
                     must be formatted according to RFC 3339 with full time and time zone included.This
                     value represents the point in time when the OSCAL document was published. Typically,
                     this date value will be machine generated at the time the containing document is published.In
                     some cases, an OSCAL document may be derived from some source material in a different
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/revisions/last-modified" class="toc4 head">last-modified</h4>Last Modified TimestampThe date and time the document was last modified. The date-time
                     value must be formatted according to RFC 3339 with full time and time zone included.This
                     value represents the point in time when the OSCAL document was last updated, or at
                     the point of creation the creation date. Typically, this date value will be machine
                     generated at time of creation or modification.In some cases, an OSCAL document may
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/revisions/version" class="toc4 head">version</h4>Document VersionA string used to distinguish the current version of the document from
                     other previous (and future) versions.A version string may be a release number, sequence
                     number, date, or other identifier suffcient to distinguish between different document
                     versions. This version is typically set by the document owner or by the tool used
                     to maintain the content.While not required, it is recommended that OSCAL content authors
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/revisions/oscal-version" class="toc4 head">oscal-version</h4>OSCAL versionThe OSCAL model version the document was authored against.Indicates the
                     version of the OSCAL model to which this data set conforms, for example 1.1.0 or 1.0.0-M1.
                     That can be used as a hint by a tool to indicate which version of the OSCAL XML or
                     JSON schema to use for validation.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/revisions/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/revisions/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/document-ids/scheme" class="toc4 head">scheme</h4>Document Identification SchemeQualifies the kind of document identifier using a URI.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/props/name" class="toc4 head">name</h4>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                     or quality of the property's containing object.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/props/uuid" class="toc4 head">uuid</h4>Property Universally Unique IdentifierA unique identifier that can be used to reference
                     this property elsewhere in an OSCAL document. A UUID should be consistently used for
                     a given location across revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/props/ns" class="toc4 head">ns</h4>Property NamespaceA namespace qualifying the property's name. This allows different
                     organizations to associate distinct semantics with the same name.Provides a means
                     to segment the value space for the name, so that different organizations and individuals
                     can assert control over the allowed names and associated values used in a property.
                     This allows the semantics associated with a given name/value pair to be defined on
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/props/value" class="toc4 head">value</h4>Property ValueIndicates the value of the attribute, characteristic, or quality.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/props/class" class="toc4 head">class</h4>Property ClassA textual label that provides a sub-type or characterization of the
                     property's name. This can be used to further distinguish or discriminate between the
                     semantics of multiple properties of the same object with the same name and ns. A class
                     can be used in validation rules to express extra constraints over named items of a
                     specific class value.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/props/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/links/href" class="toc4 head">href</h4>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                     can be an internet resource, or a local reference using a fragment e.g. #fragment
                     that points to a back-matter resource in the same document.If a local reference using
                     a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                     which references an identified resource in the document's back-matter or another object
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/links/rel" class="toc4 head">rel</h4>RelationDescribes the type of relationship provided by the link. This can be an indicator
                     of the link's purpose.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/links/media-type" class="toc4 head">media-type</h4>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                     (IANA) Media Types Registry. 
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/links/text" class="toc4 head">text</h4>Link TextA textual label to associate with the link, which may be used for presentation
                     in a tool.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/roles/id" class="toc4 head">id</h4>Role IdentifierA unique identifier for a specific role instance. This identifier's
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/roles/title" class="toc4 head">title</h4>Role TitleA name given to the role, which may be used by a tool for display and navigation.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/roles/short-name" class="toc4 head">short-name</h4>Role Short NameA short common name, abbreviation, or acronym for the role.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/roles/description" class="toc4 head">description</h4>Role DescriptionA summary of the role's purpose and associated responsibilities.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/roles/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/roles/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/locations/uuid" class="toc4 head">uuid</h4>Location Universally Unique IdentifierA unique identifier that can be used to reference
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/locations/title" class="toc4 head">title</h4>Location TitleA name given to the location, which may be used by a tool for display
                     and navigation.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/locations/address" class="toc4 head">address</h4>AddressA postal address for the location.Address TypeIndicates the type of address.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/address/type" class="toc5 head">type</h5>Address TypeIndicates the type of address.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/address/city" class="toc5 head">city</h5>CityCity, town or geographical region for the mailing address.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/address/state" class="toc5 head">state</h5>StateState, province or analogous geographical region for mailing address
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/address/postal-code" class="toc5 head">postal-code</h5>Postal CodePostal or ZIP code for mailing address
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/address/country" class="toc5 head">country</h5>Country CodeThe ISO 3166-1 alpha-2 country code for the mailing address.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/telephone-numbers/type" class="toc5 head">type</h5>type flagIndicates the type of phone number.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/locations/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/locations/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/parties/uuid" class="toc4 head">uuid</h4>Party Universally Unique IdentifierA unique identifier that can be used to reference
                     this defined location elsewhere in an OSCAL document. A UUID should be consistently
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/parties/type" class="toc4 head">type</h4>Party TypeA category describing the kind of party the object describes.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/parties/name" class="toc4 head">name</h4>Party NameThe full name of the party. This is typically the legal name associated
                     with the party.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/parties/short-name" class="toc4 head">short-name</h4>Party Short NameA short common name, abbreviation, or acronym for the party.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/external-ids/scheme" class="toc5 head">scheme</h5>External Identifier SchemaIndicates the type of external identifier.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/telephone-numbers/type" class="toc5 head">type</h5>type flagIndicates the type of phone number.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/addresses/type" class="toc5 head">type</h5>Address TypeIndicates the type of address.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/addresses/city" class="toc5 head">city</h5>CityCity, town or geographical region for the mailing address.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/addresses/state" class="toc5 head">state</h5>StateState, province or analogous geographical region for mailing address
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/addresses/postal-code" class="toc5 head">postal-code</h5>Postal CodePostal or ZIP code for mailing address
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/parties/addresses/country" class="toc5 head">country</h5>Country CodeThe ISO 3166-1 alpha-2 country code for the mailing address.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/parties/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/responsible-parties/role-id" class="toc4 head">role-id</h4>Responsible RoleThe role that the party is responsible for.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/metadata/responsible-parties/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/metadata/responsible-parties/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/metadata/remarks" class="toc3 head">remarks</h3>RemarksAdditional commentary on the containing object.
      ...
      <section class="json-obj">
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/params/id" class="toc3 head">id</h3>Parameter IdentifierA unique identifier for a specific parameter instance. This identifier's
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/params/class" class="toc3 head">class</h3>Parameter ClassA textual label that provides a characterization of the parameter.A
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/params/depends-on" class="toc3 head">depends-on</h3>Depends onAnother parameter invoking this one
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/props/name" class="toc4 head">name</h4>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                     or quality of the property's containing object.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/props/uuid" class="toc4 head">uuid</h4>Property Universally Unique IdentifierA unique identifier that can be used to reference
                     this property elsewhere in an OSCAL document. A UUID should be consistently used for
                     a given location across revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/props/ns" class="toc4 head">ns</h4>Property NamespaceA namespace qualifying the property's name. This allows different
                     organizations to associate distinct semantics with the same name.Provides a means
                     to segment the value space for the name, so that different organizations and individuals
                     can assert control over the allowed names and associated values used in a property.
                     This allows the semantics associated with a given name/value pair to be defined on
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/props/value" class="toc4 head">value</h4>Property ValueIndicates the value of the attribute, characteristic, or quality.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/props/class" class="toc4 head">class</h4>Property ClassA textual label that provides a sub-type or characterization of the
                     property's name. This can be used to further distinguish or discriminate between the
                     semantics of multiple properties of the same object with the same name and ns. A class
                     can be used in validation rules to express extra constraints over named items of a
                     specific class value.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/props/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/links/href" class="toc4 head">href</h4>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                     can be an internet resource, or a local reference using a fragment e.g. #fragment
                     that points to a back-matter resource in the same document.If a local reference using
                     a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                     which references an identified resource in the document's back-matter or another object
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/links/rel" class="toc4 head">rel</h4>RelationDescribes the type of relationship provided by the link. This can be an indicator
                     of the link's purpose.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/links/media-type" class="toc4 head">media-type</h4>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                     (IANA) Media Types Registry. 
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/links/text" class="toc4 head">text</h4>Link TextA textual label to associate with the link, which may be used for presentation
                     in a tool.
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/params/label" class="toc3 head">label</h3>Parameter LabelA short, placeholder name for the parameter, which can be used as a
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/params/usage" class="toc3 head">usage</h3>Parameter Usage DescriptionDescribes the purpose and use of a parameter
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/constraints/description" class="toc4 head">description</h4>Constraint DescriptionA textual summary of the constraint to be applied.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/params/constraints/tests/expression" class="toc5 head">expression</h5>Constraint testA formal (executable) expression of a constraint
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/params/constraints/tests/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/guidelines/prose" class="toc4 head">prose</h4>Guideline TextProse permits multiple paragraphs, lists, tables etc.
                     <div class="crosslink"><a href="../xml-reference/#/catalog/param/guideline"><button class="schema-link">Switch to XML</button></a></div>
                  </div>
               </div>
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/params/select" class="toc3 head">select</h3>SelectionPresenting a choice among alternativesParameter CardinalityDescribes the
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/params/select/how-many" class="toc4 head">how-many</h4>Parameter CardinalityDescribes the number of selections that must occur.
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/params/remarks" class="toc3 head">remarks</h3>RemarksAdditional commentary on the containing object.
      ...
      <section class="json-obj">
         ...
         <div class="obj-desc">
            <div class="obj-matrix">
               <p class="obj-name">array </p>
               <p class="occurrence"><span class="cardinality">[0 or 1]</span></p>
               <p>An array  with key <code>controls</code>.</p>
               <p class="path">/catalog/controls</p>
            </div>
         </div>
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/controls/id" class="toc3 head">id</h3>Control IdentifierA unique identifier for a specific control instance that can be
                  used to reference the control in other OSCAL documents. This identifier's uniqueness
                  is document scoped and is intended to be consistent for the same control across minor
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/controls/class" class="toc3 head">class</h3>Control ClassA textual label that provides a sub-type or characterization of the control.A
                  class can be used in validation rules to express extra constraints over named items
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/controls/title" class="toc3 head">title</h3>Control TitleA name given to the control, which may be used by a tool for display
                  and navigation.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/params/id" class="toc4 head">id</h4>Parameter IdentifierA unique identifier for a specific parameter instance. This identifier's
                     uniqueness is document scoped and is intended to be consistent for the same parameter
                     across minor revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/params/class" class="toc4 head">class</h4>Parameter ClassA textual label that provides a characterization of the parameter.A
                     class can be used in validation rules to express extra constraints over named items
                     of a specific class value.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/params/depends-on" class="toc4 head">depends-on</h4>Depends onAnother parameter invoking this one
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/params/label" class="toc4 head">label</h4>Parameter LabelA short, placeholder name for the parameter, which can be used as a
                     substitute for a value if no value is assigned.The label value should be suitable
                     for inline display in a rendered catalog.The label value should be suitable for inline
                     display in a rendered catalog.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/params/usage" class="toc4 head">usage</h4>Parameter Usage DescriptionDescribes the purpose and use of a parameter
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/constraints/description" class="toc5 head">description</h5>Constraint DescriptionA textual summary of the constraint to be applied.
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/controls/params/constraints/tests/expression" class="toc6 head">expression</h6>Constraint testA formal (executable) expression of a constraint
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/controls/params/constraints/tests/remarks" class="toc6 head">remarks</h6>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/guidelines/prose" class="toc5 head">prose</h5>Guideline TextProse permits multiple paragraphs, lists, tables etc.
                        <div class="crosslink"><a href="../xml-reference/#/catalog/control/param/guideline"><button class="schema-link">Switch to XML</button></a></div>
                     </div>
                  </div>
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/params/select" class="toc4 head">select</h4>SelectionPresenting a choice among alternativesParameter CardinalityDescribes the
                     number of selections that must occur.
                     <p>An array of Choice strings</p>
                     <p class="occurrence"><span class="cardinality">[0 or 1]</span></p>
                     <div class="obj-desc">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/params/select/how-many" class="toc5 head">how-many</h5>Parameter CardinalityDescribes the number of selections that must occur.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/params/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/props/name" class="toc4 head">name</h4>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                     or quality of the property's containing object.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/props/uuid" class="toc4 head">uuid</h4>Property Universally Unique IdentifierA unique identifier that can be used to reference
                     this property elsewhere in an OSCAL document. A UUID should be consistently used for
                     a given location across revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/props/ns" class="toc4 head">ns</h4>Property NamespaceA namespace qualifying the property's name. This allows different
                     organizations to associate distinct semantics with the same name.Provides a means
                     to segment the value space for the name, so that different organizations and individuals
                     can assert control over the allowed names and associated values used in a property.
                     This allows the semantics associated with a given name/value pair to be defined on
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/props/value" class="toc4 head">value</h4>Property ValueIndicates the value of the attribute, characteristic, or quality.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/props/class" class="toc4 head">class</h4>Property ClassA textual label that provides a sub-type or characterization of the
                     property's name. This can be used to further distinguish or discriminate between the
                     semantics of multiple properties of the same object with the same name and ns. A class
                     can be used in validation rules to express extra constraints over named items of a
                     specific class value.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/props/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/links/href" class="toc4 head">href</h4>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                     can be an internet resource, or a local reference using a fragment e.g. #fragment
                     that points to a back-matter resource in the same document.If a local reference using
                     a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                     which references an identified resource in the document's back-matter or another object
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/links/rel" class="toc4 head">rel</h4>RelationDescribes the type of relationship provided by the link. This can be an indicator
                     of the link's purpose.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/links/media-type" class="toc4 head">media-type</h4>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                     (IANA) Media Types Registry. 
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/links/text" class="toc4 head">text</h4>Link TextA textual label to associate with the link, which may be used for presentation
                     in a tool.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/parts/id" class="toc4 head">id</h4>Part IdentifierA unique identifier for a specific part instance. This identifier's
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/parts/name" class="toc4 head">name</h4>Part NameA textual label that uniquely identifies the part's semantic type.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/parts/ns" class="toc4 head">ns</h4>Part NamespaceA namespace qualifying the part's name. This allows different organizations
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/parts/class" class="toc4 head">class</h4>Part ClassA textual label that provides a sub-type or characterization of the part's
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/parts/title" class="toc4 head">title</h4>Part TitleA name given to the part, which may be used by a tool for display and navigation.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/controls/parts/prose" class="toc4 head">prose</h4>Part TextPermits multiple paragraphs, lists, tables etc.
                     <div class="crosslink"><a href="../xml-reference/#/catalog/control/part"><button class="schema-link">Switch to XML</button></a></div>
                  </div>
               </div>
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/controls/parts/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
      ...
      <section class="json-obj">
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/groups/id" class="toc3 head">id</h3>Group IdentifierA unique identifier for a specific group instance that can be used
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/groups/class" class="toc3 head">class</h3>Group ClassA textual label that provides a sub-type or characterization of the group.A
                  class can be used in validation rules to express extra constraints over named items
                  of a specific class value.A class can also be used in an OSCAL profile as a means
                  to target an alteration to control content.
         ...
         <section class="json-obj">
            <div class="header">
               <div>
                  <h3 id="/catalog/groups/title" class="toc3 head">title</h3>Group TitleA name given to the group, which may be used by a tool for display and
                  navigation.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/params/id" class="toc4 head">id</h4>Parameter IdentifierA unique identifier for a specific parameter instance. This identifier's
                     uniqueness is document scoped and is intended to be consistent for the same parameter
                     across minor revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/params/class" class="toc4 head">class</h4>Parameter ClassA textual label that provides a characterization of the parameter.A
                     class can be used in validation rules to express extra constraints over named items
                     of a specific class value.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/params/depends-on" class="toc4 head">depends-on</h4>Depends onAnother parameter invoking this one
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/params/label" class="toc4 head">label</h4>Parameter LabelA short, placeholder name for the parameter, which can be used as a
                     substitute for a value if no value is assigned.The label value should be suitable
                     for inline display in a rendered catalog.The label value should be suitable for inline
                     display in a rendered catalog.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/params/usage" class="toc4 head">usage</h4>Parameter Usage DescriptionDescribes the purpose and use of a parameter
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/constraints/description" class="toc5 head">description</h5>Constraint DescriptionA textual summary of the constraint to be applied.
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/params/constraints/tests/expression" class="toc6 head">expression</h6>Constraint testA formal (executable) expression of a constraint
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/params/constraints/tests/remarks" class="toc6 head">remarks</h6>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/guidelines/prose" class="toc5 head">prose</h5>Guideline TextProse permits multiple paragraphs, lists, tables etc.
                        <div class="crosslink"><a href="../xml-reference/#/catalog/group/param/guideline"><button class="schema-link">Switch to XML</button></a></div>
                     </div>
                  </div>
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/params/select" class="toc4 head">select</h4>SelectionPresenting a choice among alternativesParameter CardinalityDescribes the
                     number of selections that must occur.
                     <p>An array of Choice strings</p>
                     <p class="occurrence"><span class="cardinality">[0 or 1]</span></p>
                     <div class="obj-desc">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/params/select/how-many" class="toc5 head">how-many</h5>Parameter CardinalityDescribes the number of selections that must occur.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/params/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/props/name" class="toc4 head">name</h4>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                     or quality of the property's containing object.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/props/uuid" class="toc4 head">uuid</h4>Property Universally Unique IdentifierA unique identifier that can be used to reference
                     this property elsewhere in an OSCAL document. A UUID should be consistently used for
                     a given location across revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/props/ns" class="toc4 head">ns</h4>Property NamespaceA namespace qualifying the property's name. This allows different
                     organizations to associate distinct semantics with the same name.Provides a means
                     to segment the value space for the name, so that different organizations and individuals
                     can assert control over the allowed names and associated values used in a property.
                     This allows the semantics associated with a given name/value pair to be defined on
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/props/value" class="toc4 head">value</h4>Property ValueIndicates the value of the attribute, characteristic, or quality.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/props/class" class="toc4 head">class</h4>Property ClassA textual label that provides a sub-type or characterization of the
                     property's name. This can be used to further distinguish or discriminate between the
                     semantics of multiple properties of the same object with the same name and ns. A class
                     can be used in validation rules to express extra constraints over named items of a
                     specific class value.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/props/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/links/href" class="toc4 head">href</h4>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                     can be an internet resource, or a local reference using a fragment e.g. #fragment
                     that points to a back-matter resource in the same document.If a local reference using
                     a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                     which references an identified resource in the document's back-matter or another object
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/links/rel" class="toc4 head">rel</h4>RelationDescribes the type of relationship provided by the link. This can be an indicator
                     of the link's purpose.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/links/media-type" class="toc4 head">media-type</h4>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                     (IANA) Media Types Registry. 
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/links/text" class="toc4 head">text</h4>Link TextA textual label to associate with the link, which may be used for presentation
                     in a tool.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/parts/id" class="toc4 head">id</h4>Part IdentifierA unique identifier for a specific part instance. This identifier's
                     uniqueness is document scoped and is intended to be consistent for the same part across
                     minor revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/parts/name" class="toc4 head">name</h4>Part NameA textual label that uniquely identifies the part's semantic type.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/parts/ns" class="toc4 head">ns</h4>Part NamespaceA namespace qualifying the part's name. This allows different organizations
                     to associate distinct semantics with the same name.Provides a means to segment the
                     value space for the name, so that different organizations and individuals can assert
                     control over the allowed names and associated text used in a part. This allows the
                     semantics associated with a given name to be defined on an organization-by-organization
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/parts/class" class="toc4 head">class</h4>Part ClassA textual label that provides a sub-type or characterization of the part's
                     name. This can be used to further distinguish or discriminate between the semantics
                     of multiple parts of the same control with the same name and ns. A class can be used
                     in validation rules to express extra constraints over named items of a specific class
                     value.A class can also be used in an OSCAL profile as a means to target an alteration
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/parts/title" class="toc4 head">title</h4>Part TitleA name given to the part, which may be used by a tool for display and navigation.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/parts/prose" class="toc4 head">prose</h4>Part TextPermits multiple paragraphs, lists, tables etc.
                     <div class="crosslink"><a href="../xml-reference/#/catalog/group/part"><button class="schema-link">Switch to XML</button></a></div>
                  </div>
               </div>
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/parts/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/controls/id" class="toc4 head">id</h4>Control IdentifierA unique identifier for a specific control instance that can be
                     used to reference the control in other OSCAL documents. This identifier's uniqueness
                     is document scoped and is intended to be consistent for the same control across minor
                     revisions of the document.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/controls/class" class="toc4 head">class</h4>Control ClassA textual label that provides a sub-type or characterization of the control.A
                     class can be used in validation rules to express extra constraints over named items
                     of a specific class value.A class can also be used in an OSCAL profile as a means
                     to target an alteration to control content.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/groups/controls/title" class="toc4 head">title</h4>Control TitleA name given to the control, which may be used by a tool for display
                     and navigation.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/params/id" class="toc5 head">id</h5>Parameter IdentifierA unique identifier for a specific parameter instance. This identifier's
                        uniqueness is document scoped and is intended to be consistent for the same parameter
                        across minor revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/params/class" class="toc5 head">class</h5>Parameter ClassA textual label that provides a characterization of the parameter.A
                        class can be used in validation rules to express extra constraints over named items
                        of a specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/params/depends-on" class="toc5 head">depends-on</h5>Depends onAnother parameter invoking this one
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/props/name" class="toc6 head">name</h6>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                           or quality of the property's containing object.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/props/uuid" class="toc6 head">uuid</h6>Property Universally Unique IdentifierA unique identifier that can be used to reference
                           this property elsewhere in an OSCAL document. A UUID should be consistently used for
                           a given location across revisions of the document.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/props/ns" class="toc6 head">ns</h6>Property NamespaceA namespace qualifying the property's name. This allows different
                           organizations to associate distinct semantics with the same name.Provides a means
                           to segment the value space for the name, so that different organizations and individuals
                           can assert control over the allowed names and associated values used in a property.
                           This allows the semantics associated with a given name/value pair to be defined on
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/props/value" class="toc6 head">value</h6>Property ValueIndicates the value of the attribute, characteristic, or quality.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/props/class" class="toc6 head">class</h6>Property ClassA textual label that provides a sub-type or characterization of the
                           property's name. This can be used to further distinguish or discriminate between the
                           semantics of multiple properties of the same object with the same name and ns. A class
                           can be used in validation rules to express extra constraints over named items of a
                           specific class value.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/props/remarks" class="toc6 head">remarks</h6>RemarksAdditional commentary on the containing object.
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/links/href" class="toc6 head">href</h6>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                           can be an internet resource, or a local reference using a fragment e.g. #fragment
                           that points to a back-matter resource in the same document.If a local reference using
                           a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                           which references an identified resource in the document's back-matter or another object
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/links/rel" class="toc6 head">rel</h6>RelationDescribes the type of relationship provided by the link. This can be an indicator
                           of the link's purpose.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/links/media-type" class="toc6 head">media-type</h6>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                           (IANA) Media Types Registry. 
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/links/text" class="toc6 head">text</h6>Link TextA textual label to associate with the link, which may be used for presentation
                           in a tool.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/params/label" class="toc5 head">label</h5>Parameter LabelA short, placeholder name for the parameter, which can be used as a
                        substitute for a value if no value is assigned.The label value should be suitable
                        for inline display in a rendered catalog.The label value should be suitable for inline
                        display in a rendered catalog.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/params/usage" class="toc5 head">usage</h5>Parameter Usage DescriptionDescribes the purpose and use of a parameter
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/constraints/description" class="toc6 head">description</h6>Constraint DescriptionA textual summary of the constraint to be applied.
                  ...
                  <section class="json-obj">
                     ...
                     <section class="json-obj">
                        <div class="header">
                           <div>
                              <h7 id="/catalog/groups/controls/params/constraints/tests/expression" class="toc7 head">expression</h7>Constraint testA formal (executable) expression of a constraint
                     ...
                     <section class="json-obj">
                        <div class="header">
                           <div>
                              <h7 id="/catalog/groups/controls/params/constraints/tests/remarks" class="toc7 head">remarks</h7>RemarksAdditional commentary on the containing object.
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/guidelines/prose" class="toc6 head">prose</h6>Guideline TextProse permits multiple paragraphs, lists, tables etc.
                           <div class="crosslink"><a href="../xml-reference/#/catalog/group/control/param/guideline"><button class="schema-link">Switch to XML</button></a></div>
                        </div>
                     </div>
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/params/select" class="toc5 head">select</h5>SelectionPresenting a choice among alternativesParameter CardinalityDescribes the
                        number of selections that must occur.
                        <p>An array of Choice strings</p>
                        <p class="occurrence"><span class="cardinality">[0 or 1]</span></p>
                        <div class="obj-desc">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/params/select/how-many" class="toc6 head">how-many</h6>Parameter CardinalityDescribes the number of selections that must occur.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/params/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/links/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                        can be an internet resource, or a local reference using a fragment e.g. #fragment
                        that points to a back-matter resource in the same document.If a local reference using
                        a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                        which references an identified resource in the document's back-matter or another object
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/links/rel" class="toc5 head">rel</h5>RelationDescribes the type of relationship provided by the link. This can be an indicator
                        of the link's purpose.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/links/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/links/text" class="toc5 head">text</h5>Link TextA textual label to associate with the link, which may be used for presentation
                        in a tool.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/parts/id" class="toc5 head">id</h5>Part IdentifierA unique identifier for a specific part instance. This identifier's
                        uniqueness is document scoped and is intended to be consistent for the same part across
                        minor revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/parts/name" class="toc5 head">name</h5>Part NameA textual label that uniquely identifies the part's semantic type.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/parts/ns" class="toc5 head">ns</h5>Part NamespaceA namespace qualifying the part's name. This allows different organizations
                        to associate distinct semantics with the same name.Provides a means to segment the
                        value space for the name, so that different organizations and individuals can assert
                        control over the allowed names and associated text used in a part. This allows the
                        semantics associated with a given name to be defined on an organization-by-organization
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/parts/class" class="toc5 head">class</h5>Part ClassA textual label that provides a sub-type or characterization of the part's
                        name. This can be used to further distinguish or discriminate between the semantics
                        of multiple parts of the same control with the same name and ns. A class can be used
                        in validation rules to express extra constraints over named items of a specific class
                        value.A class can also be used in an OSCAL profile as a means to target an alteration
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/parts/title" class="toc5 head">title</h5>Part TitleA name given to the part, which may be used by a tool for display and navigation.
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/props/name" class="toc6 head">name</h6>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                           or quality of the property's containing object.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/props/uuid" class="toc6 head">uuid</h6>Property Universally Unique IdentifierA unique identifier that can be used to reference
                           this property elsewhere in an OSCAL document. A UUID should be consistently used for
                           a given location across revisions of the document.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/props/ns" class="toc6 head">ns</h6>Property NamespaceA namespace qualifying the property's name. This allows different
                           organizations to associate distinct semantics with the same name.Provides a means
                           to segment the value space for the name, so that different organizations and individuals
                           can assert control over the allowed names and associated values used in a property.
                           This allows the semantics associated with a given name/value pair to be defined on
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/props/value" class="toc6 head">value</h6>Property ValueIndicates the value of the attribute, characteristic, or quality.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/props/class" class="toc6 head">class</h6>Property ClassA textual label that provides a sub-type or characterization of the
                           property's name. This can be used to further distinguish or discriminate between the
                           semantics of multiple properties of the same object with the same name and ns. A class
                           can be used in validation rules to express extra constraints over named items of a
                           specific class value.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/props/remarks" class="toc6 head">remarks</h6>RemarksAdditional commentary on the containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/groups/controls/parts/prose" class="toc5 head">prose</h5>Part TextPermits multiple paragraphs, lists, tables etc.
                        <div class="crosslink"><a href="../xml-reference/#/catalog/group/control/part"><button class="schema-link">Switch to XML</button></a></div>
                     </div>
                  </div>
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/links/href" class="toc6 head">href</h6>Hypertext ReferenceA resolvable URL reference to a resource.The value of the href
                           can be an internet resource, or a local reference using a fragment e.g. #fragment
                           that points to a back-matter resource in the same document.If a local reference using
                           a fragment is used, this will be indicated by a fragment "#" followed by an identifier
                           which references an identified resource in the document's back-matter or another object
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/links/rel" class="toc6 head">rel</h6>RelationDescribes the type of relationship provided by the link. This can be an indicator
                           of the link's purpose.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/links/media-type" class="toc6 head">media-type</h6>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                           (IANA) Media Types Registry. 
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/groups/controls/parts/links/text" class="toc6 head">text</h6>Link TextA textual label to associate with the link, which may be used for presentation
                           in a tool.
      ...
      <section class="json-obj">
         <div class="header">
            <div>
               <h2 id="/catalog/back-matter" class="toc2 head">back-matter</h2>Back matterA collection of resources, which may be included directly or by reference.
               <p>An array of Resource objects</p>
               <p class="occurrence"><span class="cardinality">[0 or 1]</span></p>
               <div class="obj-desc">
                  <div class="obj-matrix">
         ...
         <section class="json-obj">
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/back-matter/resources/uuid" class="toc4 head">uuid</h4>Resource Universally Unique IdentifierA globally unique identifier that can be used
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/back-matter/resources/title" class="toc4 head">title</h4>Resource TitleA name given to the resource, which may be used by a tool for display
                     and navigation.
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/back-matter/resources/description" class="toc4 head">description</h4>Resource DescriptionA short summary of the resource used to indicate the purpose of
                     the resource.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/props/name" class="toc5 head">name</h5>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                        or quality of the property's containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/props/uuid" class="toc5 head">uuid</h5>Property Universally Unique IdentifierA unique identifier that can be used to reference
                        this property elsewhere in an OSCAL document. A UUID should be consistently used for
                        a given location across revisions of the document.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/props/ns" class="toc5 head">ns</h5>Property NamespaceA namespace qualifying the property's name. This allows different
                        organizations to associate distinct semantics with the same name.Provides a means
                        to segment the value space for the name, so that different organizations and individuals
                        can assert control over the allowed names and associated values used in a property.
                        This allows the semantics associated with a given name/value pair to be defined on
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/props/value" class="toc5 head">value</h5>Property ValueIndicates the value of the attribute, characteristic, or quality.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/props/class" class="toc5 head">class</h5>Property ClassA textual label that provides a sub-type or characterization of the
                        property's name. This can be used to further distinguish or discriminate between the
                        semantics of multiple properties of the same object with the same name and ns. A class
                        can be used in validation rules to express extra constraints over named items of a
                        specific class value.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/props/remarks" class="toc5 head">remarks</h5>RemarksAdditional commentary on the containing object.
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/document-ids/scheme" class="toc5 head">scheme</h5>Document Identification SchemeQualifies the kind of document identifier using a URI.
                        If the scheme is not provided the value of the element will be interpreted as a string
                        of characters. 
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/back-matter/resources/citation" class="toc4 head">citation</h4>CitationA citation consisting of end note text and optional structured bibliographic
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/citation/text" class="toc5 head">text</h5>Citation TextA line of citation text.
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/back-matter/resources/citation/props/name" class="toc6 head">name</h6>Property NameA textual label that uniquely identifies a specific attribute, characteristic,
                           or quality of the property's containing object.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/back-matter/resources/citation/props/uuid" class="toc6 head">uuid</h6>Property Universally Unique IdentifierA unique identifier that can be used to reference
                           this property elsewhere in an OSCAL document. A UUID should be consistently used for
                           a given location across revisions of the document.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/back-matter/resources/citation/props/ns" class="toc6 head">ns</h6>Property NamespaceA namespace qualifying the property's name. This allows different
                           organizations to associate distinct semantics with the same name.Provides a means
                           to segment the value space for the name, so that different organizations and individuals
                           can assert control over the allowed names and associated values used in a property.
                           This allows the semantics associated with a given name/value pair to be defined on
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/back-matter/resources/citation/props/value" class="toc6 head">value</h6>Property ValueIndicates the value of the attribute, characteristic, or quality.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/back-matter/resources/citation/props/class" class="toc6 head">class</h6>Property ClassA textual label that provides a sub-type or characterization of the
                           property's name. This can be used to further distinguish or discriminate between the
                           semantics of multiple properties of the same object with the same name and ns. A class
                           can be used in validation rules to express extra constraints over named items of a
                           specific class value.
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/back-matter/resources/citation/props/remarks" class="toc6 head">remarks</h6>RemarksAdditional commentary on the containing object.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/citation/biblio" class="toc5 head">biblio</h5>Bibliographic DefinitionA container for structured bibliographic information. The
            ...
            <section class="json-obj">
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/rlinks/href" class="toc5 head">href</h5>Hypertext ReferenceA resolvable URI reference to a resource.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/rlinks/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
               ...
               <section class="json-obj">
                  ...
                  <section class="json-obj">
                     <div class="header">
                        <div>
                           <h6 id="/catalog/back-matter/resources/rlinks/hashes/algorithm" class="toc6 head">algorithm</h6>Hash algorithmMethod by which a hash is derived
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/back-matter/resources/base64" class="toc4 head">base64</h4>Base64The Base64 alphabet in RFC 2045 - aligned with XSD.File NameName of the file
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/base64/filename" class="toc5 head">filename</h5>File NameName of the file before it was encoded as Base64 to be embedded in a resource.
               ...
               <section class="json-obj">
                  <div class="header">
                     <div>
                        <h5 id="/catalog/back-matter/resources/base64/media-type" class="toc5 head">media-type</h5>Media TypeSpecifies a media type as defined by the Internet Assigned Numbers Authority
                        (IANA) Media Types Registry. 
            ...
            <section class="json-obj">
               <div class="header">
                  <div>
                     <h4 id="/catalog/back-matter/resources/remarks" class="toc4 head">remarks</h4>RemarksAdditional commentary on the containing object.
