...
<div xmlns="http://www.w3.org/1999/xhtml">
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-catalog/catalog/params">Assembly (reference) <code>parameter</code> - grouped as <code>params</code></li>
         <li id="/assembly/oscal-catalog/catalog/controls">Assembly (reference) <code>control</code> - grouped as <code>controls</code></li>
         <li id="/assembly/oscal-catalog/catalog/groups">Assembly (reference) <code>group</code> - grouped as <code>groups</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-catalog/group/params">Assembly (reference) <code>parameter</code> - grouped as <code>params</code></li>
         <li id="/assembly/oscal-catalog/group/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-catalog/group/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-catalog/group/parts">Assembly (reference) <code>part</code> - grouped as <code>parts</code></li>
         <li id="/assembly/oscal-catalog/group/groups">Assembly (reference) <code>group</code> - grouped as <code>groups</code></li>
         <li id="/assembly/oscal-catalog/group/controls">Assembly (reference) <code>control</code> - grouped as <code>controls</code></li>
      </ul>
      <details>
         <summary>Metaschema source</summary>
         <pre>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-catalog/control/params">Assembly (reference) <code>parameter</code> - grouped as <code>params</code></li>
         <li id="/assembly/oscal-catalog/control/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-catalog/control/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-catalog/control/parts">Assembly (reference) <code>part</code> - grouped as <code>parts</code></li>
         <li id="/assembly/oscal-catalog/control/controls">Assembly (reference) <code>control</code> - grouped as <code>controls</code></li>
      </ul>
      <details>
         <summary>Metaschema source</summary>
         <pre>
