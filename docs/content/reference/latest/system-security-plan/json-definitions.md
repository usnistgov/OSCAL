...
description: A reference for the object definitions for the OSCAL System Security Plan model derived from this model's metaschema.
weight: 40
sidenav:
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         <li id="/assembly/oscal-ssp/system-characteristics/system-ids">Field (reference) <code>system-id</code> - grouped as <code>system-ids</code></li>
         ...
         <li id="/assembly/oscal-ssp/system-characteristics/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/system-characteristics/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         ...
         <li id="/assembly/oscal-ssp/system-characteristics/responsible-parties">Assembly (reference) <code>responsible-party</code> - grouped as <code>responsible-parties</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         <li id="/assembly/oscal-ssp/system-information/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/system-information/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/system-information/information-types">Assembly (defined inline) <code>information-type</code> - grouped as <code>information-types</code></li>
      </ul>
      <details>
         <summary>Metaschema source</summary>
         <pre>
...
&lt;/define-field&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/authorization-boundary/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/authorization-boundary/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/authorization-boundary/diagrams">Assembly (reference) <code>diagram</code> - grouped as <code>diagrams</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/diagram/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/diagram/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/network-architecture/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/network-architecture/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/network-architecture/diagrams">Assembly (reference) <code>diagram</code> - grouped as <code>diagrams</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/data-flow/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/data-flow/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/data-flow/diagrams">Assembly (reference) <code>diagram</code> - grouped as <code>diagrams</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         <li id="/assembly/oscal-ssp/system-implementation/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/system-implementation/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/system-implementation/leveraged-authorizations">Assembly (defined inline) <code>leveraged-authorization</code> - grouped as <code>leveraged-authorizations</code></li>
         <li id="/assembly/oscal-ssp/system-implementation/users">Assembly (reference) <code>system-user</code> - using name <code>user</code> - grouped as <code>users</code></li>
         <li id="/assembly/oscal-ssp/system-implementation/components">Assembly (reference) <code>system-component</code> - using name <code>component</code> - grouped as <code>components</code></li>
         <li id="/assembly/oscal-ssp/system-implementation/inventory-items">Assembly (reference) <code>inventory-item</code> - grouped as <code>inventory-items</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/control-implementation/set-parameters">Assembly (reference) <code>set-parameter</code> - grouped as <code>set-parameters</code></li>
         <li id="/assembly/oscal-ssp/control-implementation/implemented-requirements">Assembly (reference) <code>implemented-requirement</code> - grouped as <code>implemented-requirements</code></li>
      </ul>
      <details>
         <summary>Metaschema source</summary>
         <pre>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/implemented-requirement/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/implemented-requirement/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/implemented-requirement/set-parameters">Assembly (reference) <code>set-parameter</code> - grouped as <code>set-parameters</code></li>
         <li id="/assembly/oscal-ssp/implemented-requirement/responsible-roles">Assembly (reference) <code>responsible-role</code> - grouped as <code>responsible-roles</code></li>
         <li id="/assembly/oscal-ssp/implemented-requirement/statements">Assembly (reference) <code>statement</code> - grouped as <code>statements</code></li>
         <li id="/assembly/oscal-ssp/implemented-requirement/by-components">Assembly (reference) <code>by-component</code> - grouped as <code>by-components</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/statement/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/statement/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/statement/responsible-roles">Assembly (reference) <code>responsible-role</code> - grouped as <code>responsible-roles</code></li>
         <li id="/assembly/oscal-ssp/statement/by-components">Assembly (reference) <code>by-component</code> - grouped as <code>by-components</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-ssp/by-component/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-ssp/by-component/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-ssp/by-component/set-parameters">Assembly (reference) <code>set-parameter</code> - grouped as <code>set-parameters</code></li>
         ...
         <li id="/assembly/oscal-ssp/by-component/responsible-roles">Assembly (reference) <code>responsible-role</code> - grouped as <code>responsible-roles</code></li>
