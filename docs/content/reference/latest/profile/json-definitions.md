---
title: "Profile Model JSON Format Metaschema Reference"
heading: OSCAL Profile Model JSON Metaschema Reference
description: A reference for the object definitions for the OSCAL Profile model derived from this model's metaschema.
weight: 40
sidenav:
...
<div xmlns="http://www.w3.org/1999/xhtml">
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-profile/profile/imports">Assembly (reference) <code>import</code> - grouped as <code>imports</code></li>
...
&lt;/define-flag&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         <li id="/assembly/oscal-profile/custom/groups">Assembly (reference) <code>group</code> - grouped as <code>groups</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-profile/group/params">Assembly (reference) <code>parameter</code> - grouped as <code>params</code></li>
         <li id="/assembly/oscal-profile/group/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-profile/group/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-profile/group/parts">Assembly (reference) <code>part</code> - grouped as <code>parts</code></li>
         <li id="/assembly/oscal-profile/group/groups">Assembly (reference) <code>group</code> - grouped as <code>groups</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         <li id="/assembly/oscal-profile/modify/set-parameters">Assembly (defined inline) <code>set-parameter</code> - grouped as <code>set-parameters</code></li>
         <li id="/assembly/oscal-profile/modify/alters">Assembly (reference) <code>alter</code> - grouped as <code>alters</code></li>
      </ul>
      <details>
         <summary>Metaschema source</summary>
         <pre>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-profile/select-control-by-id/with-ids">Field (defined inline) <code>with-id</code> - grouped as <code>with-ids</code></li>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-profile/alter/removes">Assembly (reference) <code>remove</code> - grouped as <code>removes</code></li>
         <li id="/assembly/oscal-profile/alter/adds">Assembly (reference) <code>add</code> - grouped as <code>adds</code></li>
      </ul>
      <details>
         <summary>Metaschema source</summary>
         <pre>
...
&lt;/define-assembly&gt;
   ...
   <section class="definition define-assembly" style="margin: 0em; margin-top: 1em; padding: 0.5em; border: thin solid black">
      ...
      <ul class="model">
         ...
         <li id="/assembly/oscal-profile/add/params">Assembly (reference) <code>parameter</code> - grouped as <code>params</code></li>
         <li id="/assembly/oscal-profile/add/props">Assembly (reference) <code>property</code> - grouped as <code>props</code></li>
         <li id="/assembly/oscal-profile/add/links">Assembly (reference) <code>link</code> - grouped as <code>links</code></li>
         <li id="/assembly/oscal-profile/add/parts">Assembly (reference) <code>part</code> - grouped as <code>parts</code></li>
      </ul>
      <details>
         <summary>Metaschema source</summary>
         <pre>
