...
> * [OSCAL: The Open Security Controls Assessment Language](#) \i\c* 
...
Components may be grouped using group, and may contain either components (recursively), or be further divided into parts. Both controls and subcontrols in catalogs may be cast as "components" in an analogous (isomorphic or coordinated) framework. 

In a direct mapping from catalog to framework formats, both control and subcontrol may be regarded as components.   
